...
return {
	LeaderboardList = v1.import(script, v1.getModule(script, "@rbxts", "roact-hooks").src).new(u1)(function(p2, p3)
		local l__useState__3 = p3.useState;
		local v4 = {};
		local v5 = {
			ScrollingDirection = Enum.ScrollingDirection.Y
		};
		for v6, v7 in pairs(p2.FrameProps) do
			v5[v6] = v7;
		end;
		v4.ScrollingFrameProps = v5;
		local l__users__8 = p2.LeaderboardData.users;
		local function u10()
		...
		local function v9(p4, p5)
			...
			local v16 = {
				PlayerContainer = u1.createElement(l__Empty__5, {
					...
					PlayerAvatar = u1.createElement("ImageLabel", {
						...
						Image = p4.avatarImage, 
						LayoutOrder = 2
					}, { u1.createElement("UICorner", {
							CornerRadius = UDim.new(1, 0)
						}) }), 
					PlayerUsername = u1.createElement("TextLabel", {
						Text = "<b><font color=\"rgb(185, 188, 255)\">@</font></b>" .. p4.username, 
						RichText = true, 
						BackgroundTransparency = 1, 
						Font = Enum.Font.RobotoMono, 
						TextScaled = true, 
			...
			local v18 = p4.statRank and u1.createElement(l__StatRankElement__7, {
				StatRank = p4.statRank, 
				LayoutOrder = 1
			});
			if v18 then
				v17[#v17 + 1] = v18;
			...
			local v19 = {};
			if p4.statRank then
				local v20 = p4.statRank.rankStatValue;
			else
				v20 = p4.statValue;
			end;
			v19.Text = "<b>" .. u8(tostring(v20)) .. " " .. p2.LeaderboardData.metric .. "</b>";
			...
			if p5 + 1 == 3 then
				local v21 = u1.createElement(u10);
			else
				v21 = nil;
			end;
			if v21 then
		...
		return u1.createElement(l__AutoCanvasScrollingFrame__9, v4, v25);
	end)
};

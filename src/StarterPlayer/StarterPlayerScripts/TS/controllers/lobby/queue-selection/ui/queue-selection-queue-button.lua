-- Script Hash: 47386688ee45a422e4de61dd9dacc063b39bb26c136a4ec663c16ae7701bcd1736ed426531cd5c97dd194b51113e8554
	...
	QueueSelectionQueueButton = v1.import(script, v1.getModule(script, "@rbxts", "roact-hooks").src).new(u1)(function(p1, p2)
		...
		p2.useEffect(function()
			if l__UserInputService__2.GamepadEnabled then
				l__UIUtil__3:selectGui(u7:getValue());
			end;
		end, {});
		local v4 = {
			[u1.Ref] = u7, 

...
function v5.reconcileEffects(p9, p10, p11)
	...
	for v24 in pairs(p11) do
		if v20[v24] == nil then
			local v25 = v24.PrimaryPart;
			if v25 ~= nil then
				v25 = (v25.Position - p10.Position).Magnitude;
			end;
			local v26 = v25;
			if v26 == nil then
				v26 = 100;
			...
			if not (v26 > 18) then
				local v27 = l__EntityUtil__9:getEntity(v24);
				if v27 ~= nil then
					v27 = v27:isAlive();
				end;
				if v27 then
...
function v5.createTeslaTrapEffect(p12, p13, p14)
	local l__BodyFrontAttachment__28 = p14:FindFirstChild("UpperTorso"):FindFirstChild("BodyFrontAttachment");
	if not l__BodyFrontAttachment__28 then
		error("Could not find targetAttachment");
	end;
	local v29 = l__default__4(p13);
	if v29 then
		local v30 = v29.color;
	else
	...
	local v31 = u11.new();
	v31:GiveTask((u10.link(l__BodyFrontAttachment__28, p13.SourceAttachment, v30)));
	local v32 = {};
	...
	v32.position = v33;
	local v34 = l__SoundManager__13:playSound(l__GameSound__14.TESLA_ZAP, v32);
	if v34 then
		v34.Looped = true;

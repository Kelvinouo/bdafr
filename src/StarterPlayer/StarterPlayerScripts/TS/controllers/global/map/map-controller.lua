...
function u1.KnitStart(p2)
	...
	l__default__7.Client:OnEvent("dwYqCfsEaXenjSab", function(p7)
		p2.denyRegions = p7.blockPlaceDisabledRegions;
	end);
	p2.denyRegions = l__default__7.Client:Get("seoncjwmbuMhrIZnnmufarfjfjgtog"):CallServer().blockPlaceDisabledRegions;
end;

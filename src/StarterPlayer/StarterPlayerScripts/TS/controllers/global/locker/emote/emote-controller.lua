...
function u1.KnitStart(p2)
	...
	l__default__6.Client:OnEvent("rqhvgWwTxpwkxdfWhineksgxdstAhsa", function(p8)
		local v8 = p2:playEmoteBeginSounds(p8.emote, p8.sourcePlayer);
	end);
	l__default__6.Client:OnEvent("vtvwontarrpz", function(p9)
...
function u1.emote(p10)
	...
	local v14 = l__default__6.Client:Get("fmidqJNeAqvcjgVhn"):CallServer({
...
function u1.playEmoteAnimation(p11, p12, p13)
	...
	v20:GiveTask(function()
		...
		l__default__6.Client:Get("aoqAuvnhdnjuqaa"):CallServer({

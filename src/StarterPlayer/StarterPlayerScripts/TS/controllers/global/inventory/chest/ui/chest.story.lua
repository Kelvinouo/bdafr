...
local l__ChestInventoryApp__4 = v1.import(script, script.Parent, "chest-inventory-app").ChestInventoryApp;
...
return function(p3)
	local v3 = l__CreateRoduxApp__3("ChestInventory", l__ChestInventoryApp__4, {}, {}, {
		Parent = p3
	});

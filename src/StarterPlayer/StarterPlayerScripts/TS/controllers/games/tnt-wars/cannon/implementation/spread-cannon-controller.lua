...
local l__SPREAD_CANNON_CONFIG__1 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "tnt-wars", "cannon-constants").SPREAD_CANNON_CONFIG;
function v3.constructor(p1)
	l__BaseCannonController__2.constructor(p1, l__SPREAD_CANNON_CONFIG__1);
	p1.Name = "SpreadCannonController";
end;
function v3.onFire(p2)
	print("Firing spread cannon!");
end;
local v5 = v1.import(script, v1.getModule(script, "@easy-games", "knit").src).KnitClient.CreateController(v3.new());
return {
	SpreadCannonController = v3
};

-- Script Hash: 0da916d2539204fbc2ba4235592dffb59159ad87240aff3b58dbf199e9368aead36a065f7f02ad6dcc15c86855d140e4
...
function u1.KnitStart(p2)
	...
	l__KnitClient__6.Controllers.KitController:watchLocalKit(function(p5)
		p2.maid:DoCleaning();
		if p5 ~= l__BedwarsKit__7.LUMEN then
			return nil;
		end;
		p2.maid:GiveTask((l__Flamework__8.resolveDependency("@easy-games/game-core:client/controllers/action-bar/action-bar-controller@ActionBarController"):addComponent(l__BuildRoduxApp__9(l__LumenProgressBar__10))));
	end);
end;
...
function u1.createEffect(p6, p7)
	...
	local v8 = l__ReplicatedStorage__12.Assets.Effects.LumenUpgrade:Clone();
	local v9 = { v8 };

...
function v1.ActivateCameraController(p8, p9, p10)
	...
	if not v46 then
		if u6 and l__VRService__13.VREnabled then
			v46 = v21;
...
function v1.GetCameraControlChoice(p21)
	...
	if (not u3 or l__UserInputService__12:GetLastInputType() ~= Enum.UserInputType.Touch) and (u3 or p21.lastInputType ~= Enum.UserInputType.Touch) and not l__UserInputService__12.TouchEnabled then

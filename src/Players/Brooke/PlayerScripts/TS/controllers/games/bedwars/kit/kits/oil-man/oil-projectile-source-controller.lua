-- Script Hash: 84de24d32a7c46b31152ee955f99b99074ef9892ac7a7d9a072e7370121ffe3f1a65eb22fe5b061cb143f0514bd665da
...
function v3.onStartCharging(p6)
	...
	v5.position = v6;
	v5.parent = l__Players__7.LocalPlayer.Character;
	v5.rollOffMaxDistance = 100;
	local v7 = l__SoundManager__4:playSound(l__GameSound__5.GOO_EAT, v5);
	if v7 then
		v7.Looped = true;
	...
	local v8 = l__GameAnimationUtil__8.playAnimation(l__Players__7.LocalPlayer, l__AnimationType__9.OIL_EAT, {
		looped = true
	});
	if v8 then
		p6.eatingMaid:GiveTask(function()

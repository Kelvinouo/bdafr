...
local l__AbilityId__7 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "ability", "ability-id").AbilityId;
local l__EntityUtil__8 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "entity", "entity-util").EntityUtil;
local l__PlayerEntity__9 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "entity", "entities", "player-entity").PlayerEntity;
...
function v5.KnitStart(p2)
	...
	l__ClientSyncEvents__2.GenericMountMounted:connect(function(p3)
		if p3.mountType == l__MountType__3.DINO and p3.player == l__Players__4.LocalPlayer then
			p2.dinoMaid = u5.new();
			local u16 = l__Flamework__6.resolveDependency("@easy-games/game-core:client/controllers/ability/ability-controller@AbilityController"):enableAbility(l__AbilityId__7.DINO_CHARGE, {
				text = "Dino Attack", 
	...
	l__ClientSyncEvents__2.GenericMountDismounted:connect(function(p4)
		local l__dinoMaid__7 = p2.dinoMaid;
		if l__dinoMaid__7 ~= nil then
			l__dinoMaid__7:DoCleaning();
		end;
	end);
	l__ClientSyncEvents__2.AbilityUsed:connect(function(p5)
		local v8 = l__EntityUtil__8:getEntity(p5.userCharacter);
		if v8 == nil or not v1.instanceof(v8, l__PlayerEntity__9) then
			return nil;
		end;
		...
		if p5.ability == l__AbilityId__7.DINO_CHARGE then
			local v11 = u5.new();
			local v12 = {};
			if v9 == l__Players__4.LocalPlayer then
				local v13 = nil;
			else
			...
			l__SoundManager__10:playSound(l__GameSound__11.DINO_CHARGE_START, v12);
			local v14 = {};
			if v9 == l__Players__4.LocalPlayer then
				local v15 = nil;
			else
			...
			v14.looped = true;
			local u17 = l__SoundManager__10:playSound(l__GameSound__11.DINO_CHARGE_LOOP, v14);
			...
			v11:GiveTask(function()
				...
				l__SoundManager__10:playSound(l__GameSound__11.DINO_CHARGE_STOP, v16);
			end);
			local v18 = l__KnitClient__12.Controllers.MountController:getActiveMounts()[v9];
			if v18 ~= nil then
				v18 = v18.model;
			end;
			if v18 then
				local v19 = l__KnitClient__12.Controllers.MountAnimationController:playAnimationInMount(v18, l__AnimationType__13.DINO_CHARGING);
				if v19 then
				...
				v11:GiveTask(function()
					local v20 = l__KnitClient__12.Controllers.MountAnimationController:playAnimationInMount(v18, l__AnimationType__13.DINO_HIT);
					if v20 then
			...
			if v9 == l__Players__4.LocalPlayer then
				v11:GiveTask((l__KnitClient__12.Controllers.SprintController:getMovementStatusModifier():addModifier({
					blockSprint = true, 
					moveSpeedMultiplier = 3
				})));
				v11:GiveTask(l__RunService__14.RenderStepped:Connect(function()
					v10:Move(Vector3.new(0, 0, -1), true);
				end));
			end;
			v11:GiveTask(l__default__15.Client:Get("RemoteName"):Connect(function(p6)

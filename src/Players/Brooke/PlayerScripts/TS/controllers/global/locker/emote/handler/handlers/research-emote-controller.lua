...
function v3.constructor(p1)
	...
	p1.Name = "ResearchEmoteController";
end;
...
function v3.KnitStart(p2)
	...
	function v6.onEnable(p4, p5, p6, p7)
		local v8 = l__ReplicatedStorage__5.Assets.Misc.MageSpellbook:Clone();
		v8.Parent = p6;
	...
	u8(l__EmoteHandlerController__5, l__EmoteType__2.BOOK_READ, v6);
end;

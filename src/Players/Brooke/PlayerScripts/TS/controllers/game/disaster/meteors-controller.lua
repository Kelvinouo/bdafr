-- Script Hash: 31750d3712e9b53d243ab677ef17a3e49031d9f07bba442db9e10cf9464fd459b88d4da9bb2840fce63c4d0633cf1715
...
function v4.KnitStart(p2)
	...
	l__default__4.Client:GetNamespace("Disaster"):OnEvent("SpawnMeteor", function(p3, p4, p5, p6, p7)
		...
		v7:GiveTask(l__RunService__7.RenderStepped:Connect(function(p8)
			u11 = u11 + p8;
			local v11 = CFrame.new(v8:Lerp(v9, (l__Workspace__3:GetServerTimeNow() - p5) / (p6 - p5)).Position, p4) * CFrame.Angles(math.rad(90), 0, math.rad(90));

...
function v7.KnitStart(p2)
	...
	l__WatchCollectionTag__2(v6.tag, function(p3)
	...
	l__default__3.Client:OnEvent("RemoteName", function(p4)
		local v9 = {};
		if l__Players__4.LocalPlayer.Character and l__Players__4.LocalPlayer.Character == p4.targetEntityInstance then
			local v10 = nil;
		else
			v10 = p4.position;
		end;
		...
		l__SoundManager__5:playSound(l__GameSound__5.INVISIBLE_LANDMINE_EXPLOSION, v9);
		local v11 = l__ReplicatedStorage__6.Assets.Effects.LandmineExplosion:Clone();
	...
	l__CollectionService__9:GetInstanceRemovedSignal(v6.tag):Connect(function(p5)
...
local u11 = TweenInfo.new(v6.fadeDuration, Enum.EasingStyle.Sine, Enum.EasingDirection.In);
function v7.hideLandmine(p6, p7)
	...
	if v15 then
		...
		if v17 then
			local v18 = v6.friendlyFadeTransparency;
		else
			v18 = v6.enemyFadeTransparency;
		end;
		...
		local v19 = {};
		if v17 then
			local v20 = v6.friendlyFadeTransparency;
		else
			v20 = v6.enemyFadeTransparency;
		end;
		v19.Transparency = v20;
		local v21 = l__TweenService__10:Create(l__Landmine__14, u11, v19);
		local u12 = nil;
		u12 = v21.Completed:Connect(function()
			p6.invisibleLandmineMap[p7] = {
				isActive = true, 
				isDetonating = false
			};
			...
			p6.tweenMaid:GiveTask(u12);
			p6.tweenMaid:DoCleaning();
		end);
		v21:Play();
	end;
end;
local u13 = TweenInfo.new(v6.revealDuration, Enum.EasingStyle.Sine, Enum.EasingDirection.In);
function v7.revealLandmine(p8, p9)
	l__TweenService__10:Create(p9:WaitForChild("Landmine"), u13, {
...
function v7.startBeepLoop(p15, p16)
	local v30 = l__SoundManager__5:playSound(v6.beepSound, {
...
function v7.tagLandmineWithTeam(p17, p18)
	local v31 = l__Players__4:GetPlayerByUserId((p18:GetAttribute("PlacedByUserId")));
	if v31 then
		local v32 = v31.Team;
		if v32 ~= nil then
			v32 = v32.Name;
...
function v7.isLandmineOwner(p19, p20, p21)
	local v33 = l__Players__4:GetPlayerFromCharacter(p21.Parent);
	if v33 ~= nil then
		v33 = v33.UserId;
	end;
...
function v7.playerOnLandmineOwnersTeam(p22, p23, p24)
	local v34 = l__Players__4:GetPlayerByUserId((p23:GetAttribute("PlacedByUserId")));
	if v34 ~= nil then
		v34 = v34.Team;
		if v34 ~= nil then
			v34 = v34.Name;
	...
	local v35 = l__Players__4:GetPlayerFromCharacter(p24.Parent);
	if v35 ~= nil then
		v35 = v35.Team;
		if v35 ~= nil then
			v35 = v35.Name;
...
function v7.isFriendlyLandmine(p25, p26)
	local v36 = l__Players__4.LocalPlayer.Team;
	if v36 ~= nil then
		v36 = v36.Name;
	end;
...
function v7.isLocalPlayer(p27, p28)
	return l__Players__4.LocalPlayer.Character and p28.Parent == l__Players__4.LocalPlayer.Character;
end;
...
local v38 = v1.import(script, v1.getModule(script, "@easy-games", "knit").src).KnitClient.CreateController(v7.new());
return nil;

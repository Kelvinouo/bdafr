...
local u3 = v1.import(script, script.Parent, "no-knockback-status-effect-handler").NoKnockbackStatusEffectHandler;
function v3.KnitStart(p2)
	l__KnitController__2.KnitStart(p2);
	l__KnitClient__1.Controllers.StatusEffectController:setHandler(l__StatusEffectType__2.NO_KNOCKBACK, u3);
end;

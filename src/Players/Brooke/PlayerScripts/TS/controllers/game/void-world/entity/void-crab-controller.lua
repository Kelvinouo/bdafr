		...
		l__AnimatorAdded__3(p3:WaitForChild("Humanoid"), function(p4)
			p4.AnimationPlayed:Connect(function(p5)
				...
				if v5 == l__GameAnimationUtil__5.getAssetId(l__AnimationType__6.VOID_CRAB_BEAM_ATTACK) then
					...
					local v6 = l__LaserTarget__11.Value;
					if v6 ~= nil then
					...
					l__TargetBeam__9.Attachment1 = v6;
					l__BlastBeam__10.Attachment1 = v6;
					u12:GiveTask(l__LaserTarget__11.Changed:Connect(function()
						local v7 = l__LaserTarget__11.Value;
						if v7 ~= nil then
					...
					u12:GiveTask(p5:GetMarkerReachedSignal("blast"):Connect(function()
						...
						local u13 = l__default__7(0.1, l__Linear__8, function(p6)
							l__BlastBeam__10.Width0 = 0.1 + p6 * 0.4;
							l__BlastBeam__10.Width1 = 0.2 + p6 * 0.6;
						end);
						...
						task.delay(0.3, function()
							...
							local u14 = l__default__7(0.05, l__Linear__8, function(p7)
								l__BlastBeam__10.Width0 = 0.5 * (1 - p7);
								l__BlastBeam__10.Width1 = 0.8 * (1 - p7);
							end);
							u12:GiveTask(function()
								return u14:Cancel();
							end);

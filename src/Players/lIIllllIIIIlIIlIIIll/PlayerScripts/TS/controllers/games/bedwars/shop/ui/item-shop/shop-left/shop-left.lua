...
function v4.render(p14)
	...
	if p14.props.SelectedItem then
		v24 = l__getItemMeta__8(p14.props.SelectedItem.itemType).description;
		if v24 == nil or #v24 == 0 then
			v24 = " ";
		end;
		if (p14.props.SelectedItem.lockAfterPurchase or p14.props.SelectedItem.tiered) and l__Players__6.LocalPlayer and l__InventoryUtil__7.hasEnough(l__Players__6.LocalPlayer, p14.props.SelectedItem.itemType, 1) then
			v23 = true;
		end;
	end;
	local v25 = p14.props.SelectedItem ~= nil;
	if v25 then
		local v26 = { v2.createElement(l__ItemViewport__9, {
		...
		v26[v27 + 1] = v2.createElement("TextLabel", v28);
		local v30 = false;
		...
		local v33 = #v26;
		v26[v33 + 1] = v2.createElement("TextLabel", {
		...
		if not false then
			if v23 then
				local v34 = v2.createElement(l__Button__11, {
					Text = "<b>Purchased</b>", 
				...
				v35.Text = "<b>Purchase" .. v36 .. "</b>";
				v35.Size = UDim2.fromScale(0.9, 0.075);
				v35.Position = UDim2.fromScale(0.5, 0.98);
				v35.AnchorPoint = Vector2.new(0.5, 1);
				v35.BackgroundColor3 = l__Theme__12.backgroundSuccess;
				v35.Selectable = false;
				function v35.OnClick()
					p14:purchase();
				end;
				v34 = v2.createElement(l__Button__11, v35);
			end;
		else
			v34 = v2.createElement(l__Button__11, {
				Text = "<b>LOCKED</b>", 
				Size = UDim2.fromScale(0.9, 0.075), 
				Position = UDim2.fromScale(0.5, 0.98), 
				AnchorPoint = Vector2.new(0.5, 1), 

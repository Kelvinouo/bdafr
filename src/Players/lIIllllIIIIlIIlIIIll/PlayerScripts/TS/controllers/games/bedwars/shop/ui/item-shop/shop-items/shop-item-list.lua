...
function v4.render(p3)
	...
	local function v37(p8)
		if u13[p8.itemType] ~= nil then
			return false;
		end;
		u13[p8.itemType] = true;
	...
	local function v49(p11, p12)
		if p12.category == l__BedwarsShopItemCategory__7.Void and not l__VoidWorldUtil__8.VOID_ENABLED then
			return p11;
		end;
	...
	local function v55(p13)
		local v56 = p13[2];
		return table.find(u9, p13[1]) == nil;
	end;
	local v57 = {};
	local v58 = 0;
	...
	local function v62(p14)
		local v63 = p14[2];
		return table.find(u9, p14[1]) ~= nil;
	end;
	local v64 = {};
	local v65 = 0;
	...
	local function v72(p15, p16)
		local v73 = 8;
		if table.find(u9, p16[1]) ~= nil then
			v73 = 4;
		end;
	...
	local v80 = {
		CanvasSize = UDim2.new(p3.props.Size.X.Scale, 0, 0, v9 * local v81 + v10 * u14 + (v69 * (v77 + v78) + v70 * (v77 * 3 + v78)) + v68 * p3.state.wrapperSize.Y * 0.025 + v79 * 2), 
		Size = p3.props.Size, 

...
function v5.playEffectForItems(p15, p16, p17, p18, p19, p20)
	...
	local v23 = 0;
	local v24, v25, v26 = ipairs(p16);
	while true do
		local v27, v28 = v24(v25, v26);
		if not v27 then
			break;
		end;
		local v29 = math.min(v28.amount, p20);
		if p20 < v28.amount then
			v29 = v29 + math.log(v28.amount - p20 + 1, 2);
		end;
		local v30 = p15:cloneItemIntoModel((l__ReplicatedStorage__10:WaitForChild("Items"):WaitForChild(v28.itemType)));
		local v31 = 0;
		local v32 = false;
		while true do
			if v32 then
			...
			if not (v31 < math.ceil(v29)) then
				break;
			end;
			local u13 = v23;
			task.spawn(function()
				task.wait(math.random() * 0.2);
				p15:playEffect(v30, p17, p18, 0.5 + math.random() * 0.2):andThen(function(p21)
					if p21 then
						local v33 = {};
						...
						v33.position = v34;
						v33.volumeMultiplier = 0.8;
						local v36 = l__SoundManager__11:playSound(l__GameSound__12.PICKUP_ITEM_DROP, v33);
						if v36 then
							u13 = u13 + 1;
							v36.PlaybackSpeed = 1 + u13 / 50;
						end;
					end;
				end);
			end);		

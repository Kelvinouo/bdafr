-- Script Hash: dfb337daff6490e51982b676223b8a847e07a5d4cbd7a61513146b4973a2272b06487435a754758a023f50555cf1dde4
...
function v4.KnitStart(p2)
	...
	l__CollectionService__2:GetInstanceAddedSignal("LassoHooked"):Connect(function(p3)
		local v6 = l__ReplicatedStorage__3.Assets.Misc.LassoWrap:Clone();
		v6.Parent = p3;
		...
		l__WeldUtil__4.weldParts(v6.Rope, l__UpperTorso__7);
		local v8 = u5.new();
		v8:GiveTask(v6);
	...
	l__ClientSyncEvents__6.ProjectileLaunched:connect(function(p5)
		...
		local v10 = l__EntityUtil__7:getEntity(p5.shooter);
		if not v10 then
			return nil;
		end;
		...
		local v16 = l__SoundManager__8:playSound(l__GameSound__9.GRAPPLING_HOOK_EXTEND_LOOP, {

-- Script Hash: 4a9f36f51d4f86c4e87b1daa8ea156d542a778993bb0415fb18606df78fb76e62588a960f251702edef1954770029c69
...
function v3.KnitStart(p2)
	...
	l__ClientSyncEvents__7.SwordCharge:connect(function(p3)
		local v5 = l__EntityUtil__8:getEntity(l__Players__9.LocalPlayer);
		if p3.itemType.itemType ~= l__ItemType__4.FRYING_PAN then
			return nil;
		end;
		if p3.chargeState == l__ChargeState__10.Charging then
			local v6 = l__Players__9.LocalPlayer.Character;
			if v6 ~= nil then
			...
			local v7 = l__getItemMeta__11(p3.itemType.itemType);
			local v8 = v7.sword;
			if v8 ~= nil then
				v8 = v8.chargedAttack;
			end;
			...
			u14 = v6:LoadAnimation(l__GameAnimationUtil__12.getAnimation(l__AnimationType__5.PAN_CHARGE));
			u14:Play();
			u14:AdjustSpeed(u14.Length / v7.sword.chargedAttack.maxChargeTimeSec);
			...
			local v9 = l__SoundManager__13:playSound(l__GameSound__6.FRYING_PAN_CHARGE);
			if v9 then
				p2.animationMaid:GiveTask(function()
					v9:Stop();
				end);

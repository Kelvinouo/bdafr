...
local u1 = l__PrefabBlockHandler__2;
function v3.constructor(p1, p2, p3, p4, p5)
	u1.constructor(p1, p2, p3, p4, nil);
	p1.blockOptions = p5;
end;
...
function v3.createNewInstance(p6, p7)
	local v5 = l__ReplicatedStorage__3.Assets.Blocks:WaitForChild((l__RandomUtil__2.fromList(unpack(p6.blockOptions)))):WaitForChild("Root"):Clone();
	v5.Name = p6:getBlockType();
	return v5;
end;
function v3.place(p8, p9, p10, p11)
	return u1.place(p8, p9, p10, {
...
return l__PrefabBlockHandler__2;

...
local l__Gamepass__6 = v2.import(script, game:GetService("ReplicatedStorage"), "TS", "place", "gamepass").Gamepass;
local l__PlaceUtil__7 = v2.import(script, game:GetService("ReplicatedStorage"), "TS", "util", "place-util").PlaceUtil;
local l__BedwarsKitSkin__8 = v2.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit-skin", "bedwars-kit-skin").BedwarsKitSkin;
local l__BedwarsKit__9 = v2.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "bedwars-kit").BedwarsKit;
local l__BedwarsClass__10 = v2.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "class", "bedwars-class").BedwarsClass;
local v11 = {
	[l__BedwarsKit__9.NONE] = {
		name = "None", 
		description = "", 
		notGiftable = true, 
		renderImage = "", 
...
local v12 = {};
if l__PlaceUtil__7.isProduction() then
	local v13 = 18876495;
else
	v13 = 18875964;
end;
v12.gamepassId = v13;
v12.priceRobux = 399;
v12.name = "Farmer Cletus";
v12.description = "As a master of the farmland, Cletus grows crops that yield diamonds and emeralds.";
v12.previewItems = { l__ItemType__5.WATERING_CAN };
v12.renderImage = "rbxassetid://9155466936";
v12.skins = { l__BedwarsKitSkin__8.FARMER_CLETUS_SPIRIT };
v12.kitClass = l__BedwarsClass__10.ECONOMY;
v11[l__BedwarsKit__9.FARMER_CLETUS] = v12;
local v14 = {};
if l__PlaceUtil__7.isProduction() then
	local v15 = 19551065;
else
...
v14.priceRobux = 399;
v14.name = "Barbarian";
v14.description = "Build rage by damaging enemies. Instead of buying swords, your sword is upgraded upon reaching max rage. You lose half your rage upon death. Emerald Sword is replaced by the Rageblade.";
v14.previewItems = { l__ItemType__5.RAGEBLADE };
v14.skins = { l__BedwarsKitSkin__8.BARBARIAN_DEEP_VOID, l__BedwarsKitSkin__8.BARBARIAN_VICTORIOUS };
v14.renderImage = "rbxassetid://9166207628";
v14.kitClass = l__BedwarsClass__10.FIGHTER;
v11[l__BedwarsKit__9.BARBARIAN] = v14;
local v16 = {};
if l__PlaceUtil__7.isProduction() then
	local v17 = 19088340;
else
...
v16.priceRobux = 399;
v16.name = "Builder";
v16.description = "Fortify blocks with extra health and blast protection using the Builder's hammer. Purchase the Hammer from the Item Shop.";
v16.renderImage = "rbxassetid://9155463708";
v16.previewItems = { l__ItemType__5.HAMMER };
v16.kitClass = l__BedwarsClass__10.DEFENDER;
v11[l__BedwarsKit__9.BUILDER] = v16;
local v18 = {};
if l__PlaceUtil__7.isProduction() then
	local v19 = 19086951;
else
...
v18.priceRobux = 399;
v18.name = "Baker";
v18.description = "Gain access to health-gain apples and speed-boost cakes.";
v18.renderImage = "rbxassetid://9155463919";
v18.skins = { l__BedwarsKitSkin__8.BAKER_SPIRIT };
v18.previewItems = { l__ItemType__5.PIE };
v18.kitClass = l__BedwarsClass__10.SUPPORT;
v11[l__BedwarsKit__9.BAKER] = v18;
local v20 = {};
if l__PlaceUtil__7.isProduction() then
	local v21 = 19275795;
else
...
v20.priceRobux = 399;
v20.name = "Archer";
v20.description = "+15% projectile damage and access to the Tactical Crossbow in Item Shop.";
v20.previewItems = { l__ItemType__5.TACTICAL_CROSSBOW };
v20.renderImage = "rbxassetid://9224796984";
v20.kitClass = l__BedwarsClass__10.FIGHTER;
v11[l__BedwarsKit__9.ARCHER] = v20;
local v22 = {};
if l__PlaceUtil__7.isProduction() then
	local v23 = 19546564;
else
...
v22.gamepassId = v23;
v22.priceRobux = 399;
v22.name = "Infernal Shielder";
v22.description = "Spawn with a massive shield that can deflect damage + projectile knockback.";
v22.renderImage = "rbxassetid://9155464114";
v22.previewItems = { l__ItemType__5.INFERNAL_SHIELD };
v22.kitClass = l__BedwarsClass__10.TANK;
v11[l__BedwarsKit__9.SHIELDER] = v22;
local v24 = {};
if l__PlaceUtil__7.isProduction() then
	local v25 = 19722364;
else
...
v24.priceRobux = 399;
v24.name = "Melody";
v24.description = "Use a guitar and the power of music to heal nearby teammates. Heal yourself for 20% of heal given.";
v24.renderImage = "rbxassetid://9155464915";
v24.previewItems = { l__ItemType__5.GUITAR };
v24.skins = { l__BedwarsKitSkin__8.MELODY_ROCKSTAR };
v24.kitClass = l__BedwarsClass__10.SUPPORT;
v11[l__BedwarsKit__9.MELODY] = v24;
local v26 = {};
if l__PlaceUtil__7.isProduction() then
	local v27 = 20030035;
else
...
v26.gamepassId = v27;
v26.priceRobux = 399;
v26.name = "Pirate Davey";
v26.description = "Use a TNT Cannon to bombard your enemies.";
v26.renderImage = "rbxassetid://9155464612";
v26.skins = { l__BedwarsKitSkin__8.DAVEY_GHOST };
v26.kitClass = l__BedwarsClass__10.DESTROYER;
v11[l__BedwarsKit__9.DAVEY] = v26;
local v28 = {};
if l__PlaceUtil__7.isProduction() then
	local v29 = 20245233;
else
...
v28.priceRobux = 399;
v28.name = "Eldertree";
v28.description = "Collect tree orbs around the map to increase size and max HP. Cannot buy armor.";
v28.renderImage = "rbxassetid://9155467211";
v28.forceSkin = true;
v28.skins = { l__BedwarsKitSkin__8.BIGMAN_SPIRIT };
v28.kitClass = l__BedwarsClass__10.TANK;
v11[l__BedwarsKit__9.BIGMAN] = v28;
local v30 = {};
if l__PlaceUtil__7.isProduction() then
	local v31 = 20645574;
else
...
v30.priceRobux = 399;
v30.name = "Lassy";
v30.description = "Wrangle enemies towards you using a lasso.";
v30.renderImage = "rbxassetid://9155462968";
v30.previewItems = { l__ItemType__5.LASSO };
v30.kitClass = l__BedwarsClass__10.FIGHTER;
v11[l__BedwarsKit__9.COWGIRL] = v30;
v11[l__BedwarsKit__9.GRIM_REAPER] = {
	gamepassId = 20872871, 
	priceRobux = 399, 
	name = "Grim Reaper", 
...
v11[l__BedwarsKit__9.VULCAN] = {
	...
	skins = { l__BedwarsKitSkin__8.VULCAN_LUNAR }, 
	kitClass = l__BedwarsClass__10.DEFENDER
};
v11[l__BedwarsKit__9.PYRO] = {
	name = "Pyro", 
...
v11[l__BedwarsKit__9.BEEKEEPER] = {
	...
	kitClass = l__BedwarsClass__10.ECONOMY
};
v11[l__BedwarsKit__9.JADE] = {
	name = "Jade", 
	...
	kitClass = l__BedwarsClass__10.MOVEMENT
};
v11[l__BedwarsKit__9.WARRIOR] = {
	name = "Warrior", 
	...
	kitClass = l__BedwarsClass__10.TANK
};
v11[l__BedwarsKit__9.BOUNTY_HUNTER] = {
	name = "Bounty Hunter", 
...
v11[l__BedwarsKit__9.SPIRIT_CATCHER] = {
	name = "Spirit Catcher", 
...
if l__PlaceUtil__7.isProduction() then
	local v33 = 1207029649;
else
	v33 = 1206777428;
end;
v32.devProductId = v33;
v32.renderImage = "rbxassetid://9166208240";
v32.kitClass = l__BedwarsClass__10.SUPPORT;
v11[l__BedwarsKit__9.ANGEL] = v32;
v11[l__BedwarsKit__9.AXOLOTL] = {
	name = "Axolotl Amy", 
	...
	skins = { l__BedwarsKitSkin__8.AXOLOTL_REINDEER, l__BedwarsKitSkin__8.AXOLOTL_EASTER_BUNNY }, 
	kitClass = l__BedwarsClass__10.SUPPORT
};
v11[l__BedwarsKit__9.TRAPPER] = {
	name = "Trapper", 
...
v11[l__BedwarsKit__9.FISHERMAN] = {
	name = "Fisherman", 
...
v11[l__BedwarsKit__9.GHOST_CATCHER] = {
	name = "Gompy", 
...
v11[l__BedwarsKit__9.OIL_MAN] = {
	...
	kitClass = l__BedwarsClass__10.MISC
};
v11[l__BedwarsKit__9.SPEARMAN] = {
	name = "Ares", 
...
v11[l__BedwarsKit__9.ICE_QUEEN] = {
	...
	skins = { l__BedwarsKitSkin__8.FREIYA_TIGER_BRAWLER }, 
	kitClass = l__BedwarsClass__10.FIGHTER
};
v11[l__BedwarsKit__9.AERY] = {
	name = "Aery", 
	...
	unlockedInBattlePass = true, 
	skins = { l__BedwarsKitSkin__8.ACADEMY_AERY }, 
	kitClass = l__BedwarsClass__10.FIGHTER
};
v11[l__BedwarsKit__9.YETI] = {
	name = "Yeti", 
	...
	kitClass = l__BedwarsClass__10.DESTROYER
};
v11[l__BedwarsKit__9.GINGERBREAD_MAN] = {
...
v11[l__BedwarsKit__9.DASHER] = {
	...
	skins = { l__BedwarsKitSkin__8.DASHER_TIGER, l__BedwarsKitSkin__8.YUZI_VICTORIOUS }, 
	kitClass = l__BedwarsClass__10.MOVEMENT
};
v11[l__BedwarsKit__9.ALCHEMIST] = {
	name = "Alchemist", 
...
v11[l__BedwarsKit__9.MINER] = {
	...
	skins = { l__BedwarsKitSkin__8.MINER_SPACE }, 
	priceRobux = 399, 
	gamepassId = l__Gamepass__6.MINER, 
	kitClass = l__BedwarsClass__10.ECONOMY
};
v11[l__BedwarsKit__9.MIDNIGHT] = {
	name = "Nyx", 
...
v11[l__BedwarsKit__9.SHEEP_HERDER] = {
	name = "Sheep Herder", 
...
v11[l__BedwarsKit__9.METAL_DETECTOR] = {
	name = "Metal Detector", 
...
v11[l__BedwarsKit__9.CONQUEROR] = {
	name = "Conqueror", 
...
v11[l__BedwarsKit__9.CYBER] = {
	...
	priceRobux = 399, 
	gamepassId = 42490369, 
	skins = { l__BedwarsKitSkin__8.CYBER_DJ }, 
	kitClass = l__BedwarsClass__10.ECONOMY
};
v11[l__BedwarsKit__9.EMBER] = {
	name = "Ember", 
...
v11[l__BedwarsKit__9.DINO_TAMER] = {
	name = "Dino Tamer Dom", 
...
v11[l__BedwarsKit__9.WIND_WALKER] = {
	name = "Zephyr", 
...
v11[l__BedwarsKit__9.STAR_COLLECTOR] = {
...
v11[l__BedwarsKit__9.SPIRIT_ASSASSIN] = {
	name = "Evelynn", 
	...
	priceRobux = 399, 
	gamepassId = l__Gamepass__6.EVELYNN, 
	kitClass = l__BedwarsClass__10.FIGHTER, 
	skins = { l__BedwarsKitSkin__8.SPIRIT_ASSASSIN_PRISMATIC }, 
	featured = true
};
v11[l__BedwarsKit__9.BATTERY] = {
	name = "Cobalt", 
...
local function v35(p1, p2)
	local v36 = {};
	local v37 = 0;
	local v38, v39, v40 = ipairs((v3.entries(v11)));
	while true do
		v38(v39, v40);
		if not v38 then
			break;
		...
		local v41 = v39[2];
		if v41.battlepassSeason and v41.battlepassSeason == p2 then
			local v42 = v39[1];
		else
			v42 = nil;
		end;

...
local v3 = {
	...
	[l__MapType__1.BEDWARS_THIRTY_VS_THIRTY] = { "to30_Aztec", "to30_Castle", "to30_Campsite", "to30_Fortress", "to30_Ships-Ahoy", "to30_Reservoir" }
};
local v4 = {

...
return {
	default = v2.Definitions.Create({
		...
		wcbmhHa = v2.Definitions.ServerFunction(), 
		elsEgrnl = v2.Definitions.ClientToServerEvent(), 
		tkaudSnzvjrKsnpQ = v2.Definitions.ClientToServerEvent(), 
		...
		vrZxzmctr = v2.Definitions.ServerFunction({ l__WrappedTypechecker__5(l__t__3.interface({
				weapon = l__t__3.Instance
			})) }), 
		Ywdwkunzvhegfs = v2.Definitions.ServerFunction({ l__WrappedTypechecker__5(l__t__3.Instance) }), 
		Bounce = v2.Definitions.ServerToClientEvent(), 
		GroundHit = v2.Definitions.ClientToServerEvent(), 
		ffGkkgxqrvkv = v2.Definitions.ClientToServerEvent(), 
		laizuzhqyyTbwppsZltxchelayHZlsqvaf = v2.Definitions.ServerFunction(), 
		ErYfhLGjkaqeOkrAq = v2.Definitions.ServerFunction(), 
		...
		kvdyk = v2.Definitions.ClientToServerEvent(), 
		yDNLaywexrBwnktdujskkxvmmehucgrokxzNezAlg = v2.Definitions.ServerFunction(), 
		xgtrZwoxieqgzxmtpaahvccgerwsk = v2.Definitions.ServerFunction(), 
		HzBtgltUtgHvprsikhOcxlaqNzpxydneE = v2.Definitions.ClientToServerEvent({ v2.Middleware.RateLimit({
		...
		dRkhXembjivjebeesd = v2.Definitions.ClientToServerEvent(), 
		pckygwxsiyzHjnnwxsw = v2.Definitions.ServerFunction(), 
		gamxskkesrplgNcUu = v2.Definitions.ServerFunction(), 
		IeWByyxgNdqvaxcXbgecNzkrCfmbqpjvFdhawhE = v2.Definitions.ClientToServerEvent(), 
		ngzkyvklkkndrkSxzqq = v2.Definitions.ClientToServerEvent(), 
		pfjJwntknRpxhpshalqlGpkckr = v2.Definitions.ClientToServerEvent(), 
		Lpkzrqnutyuxnrazo = v2.Definitions.ClientToServerEvent(), 
		mnrdiyiHcrsjOqwyinGe = v2.Definitions.ServerFunction(), 
		ExshpbohoyirbtyJxgtdxsGynjxc = v2.Definitions.ClientToServerEvent(), 
		hoPukfJiflQEiutio = v2.Definitions.ClientToServerEvent(), 
		HhkyLjzodb = v2.Definitions.ClientToServerEvent(), 
		ksYqaTdkowuWj = v2.Definitions.ServerFunction(), 
		ssiambcjkmc = v2.Definitions.ClientToServerEvent(), 
		AwbaFmmgDjvbttaKcVBcUanmu = v2.Definitions.ClientToServerEvent(), 
		dqcorwIttcRzcqjzpndnaXuyyqbuckRrl = v2.Definitions.ClientToServerEvent(), 
		qrrcgTme = v2.Definitions.ClientToServerEvent(), 
		wRMaw = v2.Definitions.ServerFunction(), 
		dSpjtiqamyfftnkxytvwgbeMXzvzjcgmfw = v2.Definitions.ServerFunction(), 
		lqktwkgIvmdGvivmwauqNhkQheE = v2.Definitions.ServerFunction(), 
		luxkrewzqmpvuepch = v2.Definitions.ServerFunction(), 
		DltzozsFsquesvsaohhjbkach = v2.Definitions.ServerFunction(), 
		kwgpjtaDxlbvqifqgttznvwtDL = v2.Definitions.ServerFunction(), 
		ByzZbGJsdmGlu = v2.Definitions.ServerFunction(), 
		nkLdscgnrrtmMvloBWqagsJZAhbidnlncdWu = v2.Definitions.ServerFunction(), 
		sojCh = v2.Definitions.ServerFunction(), 
		eujskcd = v2.Definitions.ClientToServerEvent(), 
		ciyapilzznbzhwysyphlApsjdv = v2.Definitions.ServerToClientEvent(), 
		ttlfycyicibbgzsxPi = v2.Definitions.ServerToClientEvent(), 
		NxelbiCdAAtyePhcdizyoidm = v2.Definitions.ServerToClientEvent(), 
		dwaipicxoardrehPsicthgrnc = v2.Definitions.ClientToServerEvent(), 
		qEzdzsoafoNffnu = v2.Definitions.ClientToServerEvent(), 
		...
		jrissfpjhyvlaurxgfuhdzvztmonz = v2.Definitions.ClientToServerEvent(), 
		cfVEOQmyefdd = v2.Definitions.ClientToServerEvent(), 
		xCMxqaxier = v2.Definitions.ClientToServerEvent(), 
		ukhmmhdopw = v2.Definitions.ClientToServerEvent(), 
		xbaovnugoiHvxYkrmecovkjeDu = v2.Definitions.ClientToServerEvent(), 
		msaeytidykyslGLrtJrMHokqFYsaxceaooFikpGy = v2.Definitions.ClientToServerEvent(), 
		facazSdOkBpkCxxxcevwKgwm = v2.Definitions.ClientToServerEvent(), 
		VaEvtyyxcDtnb = v2.Definitions.ClientToServerEvent(), 
		Cpmoklvxodns = v2.Definitions.ClientToServerEvent(), 
		ntvlqeD = v2.Definitions.ClientToServerEvent(), 
		bPEoc = v2.Definitions.ClientToServerEvent(), 
		Ihqxbwxlgph = v2.Definitions.ServerFunction(), 
		amcmUmdSwzjbcBXzimsK = v2.Definitions.ClientToServerEvent(), 
		puljtsaGRcplsHnluJpj = v2.Definitions.ServerFunction(), 
		IyRphAHvbzb = v2.Definitions.ClientToServerEvent(), 
		lwEetihnewkvqQNKji = v2.Definitions.ClientToServerEvent(), 
		uHrWgOdevtKXzctQ = v2.Definitions.ClientToServerEvent(), 
		CyiZvehbgatbhz = v2.Definitions.ClientToServerEvent(), 
		RxGhjakebgrxXsRxkqldP = v2.Definitions.ClientToServerEvent(), 
		ymlzzedqjtizpoJ = v2.Definitions.ClientToServerEvent(), 
		wnbhojOqnjqxWkwsconsoumwayjg = v2.Definitions.ServerFunction(), 
		bluSwrb = v2.Definitions.ClientToServerEvent(), 
		yjacokmj = v2.Definitions.ServerFunction(), 
		...
		tfgrziwXbkhibjspEecv = v2.Definitions.ServerFunction(), 
		kzxdahHJKamayeWtrqvmbe = v2.Definitions.ServerFunction(), 
		FjchlrzcrofzvmmlYQwjkoomcBaNq = v2.Definitions.ServerFunction(), 
		jkvtspyuarydzDmkw = v2.Definitions.ClientToServerEvent(), 
		jfpiracvhvlglvAmhgxcvobCrrgmn = v2.Definitions.ClientToServerEvent(), 
		EuZddethfmncFmjiEdtfYbCTqPnBQz = v2.Definitions.ClientToServerEvent(), 
		uNqkbpirgchyonksifBrYM = v2.Definitions.ClientToServerEvent(), 
		nzk = v2.Definitions.ClientToServerEvent(), 
		dezowsmlufjufyqgIrjr = v2.Definitions.ClientToServerEvent(), 
		ddzock = v2.Definitions.ClientToServerEvent(), 
		ywoidwcrYpiwhrgnf = v2.Definitions.ClientToServerEvent(), 
		dseWohtnvhwPioVitwqugmxcrVwgRaPtyl = v2.Definitions.ClientToServerEvent(), 
		RequestStatusUpdate = v2.Definitions.ClientToServerEvent(), 
		qhhubRjfrkbvneicwhglrbn = v2.Definitions.ClientToServerEvent(), 
		vrPeronmfwgdXhrbwThpfSHqd = v2.Definitions.ClientToServerEvent(), 
		cbjdl = v2.Definitions.ClientToServerEvent(), 
		...
		mXxp = v2.Definitions.ServerToClientEvent(), 
		...
		mUoopqhtkttemEypalualssjujFstitaVjdwz = v2.Definitions.ServerToClientEvent(), 
		...
		jltKhcdggyyqzzQHwFZbmLukajbgfogs = v2.Definitions.ServerToClientEvent(), 
		...
		iKhykwqapfAobgtOfwirvhwvwe = v2.Definitions.ServerToClientEvent(), 
		gkxibfsxnAshPr = v2.Definitions.ServerToClientEvent(), 
		ckkiztAlXqagaO = v2.Definitions.ServerToClientEvent(), 
		...
		qqIdkcbNbyumrjGkjGpu = v2.Definitions.ServerToClientEvent(), 
		PzebtuwCkmpbiIgu = v2.Definitions.ServerToClientEvent(), 
		qqIdkcbNbyumrjGkjGpu = v2.Definitions.ServerToClientEvent(), 
		lcvcacehtmBwvrxiwcda = v2.Definitions.ServerToClientEvent(), 
		VcmclvZJoSagqBibcWdCnzvgmpmhqe = v2.Definitions.ServerToClientEvent(), 
		dvhWjpRzw = v2.Definitions.ServerToClientEvent(), 
		btvBsoruh = v2.Definitions.ServerToClientEvent(), 
		mucypdphcssxepqKodujdZcdlCobqmisoNdxgnoIpo = v2.Definitions.ClientToServerEvent(), 
		jhkwaxWht = v2.Definitions.ServerToClientEvent(), 
		azgznQlehyVZtsfihtblkqefuahWeym = v2.Definitions.ServerToClientEvent(), 
		ctfefcbvhd = v2.Definitions.ServerToClientEvent(), 
		ujneNMsoxsyePlN = v2.Definitions.ClientToServerEvent(), 
		cDqwqamtfyrkaylttit = v2.Definitions.ServerToClientEvent(), 
		ouoxcyctkpQTusyXsdopzteb = v2.Definitions.ServerToClientEvent(), 
		tgvsxbicPm = v2.Definitions.ServerToClientEvent(), 
		lNdmJkielkojKwsmgaenCh = v2.Definitions.ServerToClientEvent(), 
		rocScnspRbnxlnNmzjzc = v2.Definitions.ServerToClientEvent(), 
		laiPfoFqRGCzc = v2.Definitions.ServerToClientEvent(), 
		eVrsbkbFat = v2.Definitions.ServerToClientEvent(), 
		abklrZliifdJhnaQC = v2.Definitions.ServerToClientEvent(), 
		DjnDupnjIyFrStqtmdnafhNKbNwvtcTBlThznmkIMy = v2.Definitions.ServerToClientEvent(), 
		mntkuzcpvfmheiyq = v2.Definitions.ServerToClientEvent(), 
		oiXDLgvZe = v2.Definitions.ServerToClientEvent(), 
		djdicUutRbixyzgn = v2.Definitions.ServerToClientEvent(), 
		hUzgHuqsDuesRp = v2.Definitions.ServerToClientEvent(), 
		jrzflhlDcwh = v2.Definitions.ServerToClientEvent(), 
		pktwhlkug = v2.Definitions.ServerToClientEvent(), 
		bWRlibdzdaos = v2.Definitions.ServerToClientEvent(), 
		ReotqwefrycvxlTxxrk = v2.Definitions.ServerToClientEvent(), 
		smkhLAaswNxNnRehuuwi = v2.Definitions.ServerToClientEvent(), 
		ekmxhtXhdVronSPtgtrsiyujkyoMujKmjiwtSm = v2.Definitions.ServerToClientEvent(), 
		Hehnj = v2.Definitions.ServerToClientEvent()
	}, {})
};

...
return {
	default = v2.Definitions.Create({
		...
		RocktBeltUsed = v2.Definitions.ClientToServerEvent(), 
		CannonLookVectorUpdate = v2.Definitions.ClientToServerEvent(), 
		CannonLoadTNT = v2.Definitions.ClientToServerEvent(), 
		CannonFireRequest = v2.Definitions.ClientToServerEvent(), 
		WallBuilderPlaced = v2.Definitions.ClientToServerEvent(), 
		HealingBackpackUsed = v2.Definitions.ClientToServerEvent(), 
		...
		CannonSuccessfullyFired = v2.Definitions.ServerToClientEvent(), 
		CannonLoadTNTResult = v2.Definitions.ServerToClientEvent(), 
		BombExplosion = v2.Definitions.ServerToClientEvent(), 
		BlocksBrokenByExplosion = v2.Definitions.ServerToClientEvent(), 
		...
		SwordHit = v2.Definitions.ClientToServerEvent({ l__WrappedTypechecker__5(l__t__3.interface({
		...
		SetBackpackInvItem = v2.Definitions.ServerFunction(), 
		...
		RequestSelfDeath = v2.Definitions.ClientToServerEvent({ v2.Middleware.RateLimit({
				MaxRequestsPerMinute = 30, 
				ErrorHandler = v4
			}) }), 
		...
		UseGlitchShield = v2.Definitions.ClientToServerEvent(), 
		PlayGuitar = v2.Definitions.ClientToServerEvent(), 
		PlayGlitchGuitar = v2.Definitions.ClientToServerEvent(), 
		StopPlayingGuitar = v2.Definitions.ClientToServerEvent(), 
		StopPlayingGlitchGuitar = v2.Definitions.ClientToServerEvent(), 
		FetchStats = v2.Definitions.ServerFunction(), 
		PirateFlagPickUpItem = v2.Definitions.ServerFunction(), 
		PirateTelescopeAura = v2.Definitions.ServerFunction(), 
		...
		UseSpirit = v2.Definitions.ServerFunction(), 
		OpenChest = v2.Definitions.ServerFunction(), 
		HannahPromptTrigger = v2.Definitions.ServerFunction(), 
		DetonateBomb = v2.Definitions.ServerFunction(), 
		TrumpetPlay = v2.Definitions.ServerFunction(), 
		GlitchTrumpetPlay = v2.Definitions.ServerFunction(), 
		SpiritTeleport = v2.Definitions.ServerFunction(), 
		...
		SetFOV = v2.Definitions.ClientToServerEvent(), 
		...
		DepositCoins = v2.Definitions.ServerFunction(), 
		...
		ReflectGlitchProjectileEffects = v2.Definitions.ServerToClientEvent(), 
		...
		GlitchProjectileDeflected = v2.Definitions.ServerToClientEvent(), 
		...
		SurvivalStateChange = v2.Definitions.ServerToClientEvent(), 
		BatterySpawn = v2.Definitions.ServerToClientEvent(), 
		ConsumeBattery = v2.Definitions.ClientToServerEvent(), 
		BatteryConsumed = v2.Definitions.ServerToClientEvent(), 
		BatteryOverload = v2.Definitions.ServerToClientEvent(), 
		MakeSnowCone = v2.Definitions.ServerFunction(), 
		RepairSnowConeMachine = v2.Definitions.ServerFunction(), 
		SnowConeMade = v2.Definitions.ServerToClientEvent(), 
		TennisBallExplode = v2.Definitions.ServerToClientEvent(), 
		DropPiano = v2.Definitions.ServerToClientEvent(), 
		ItemConsumed = v2.Definitions.ServerToClientEvent(), 
		CreatedTNTWarsBalloon = v2.Definitions.ServerToClientEvent(), 
		PoppedTNTWarsBalloon = v2.Definitions.ServerToClientEvent(), 
		UnlockPirateCategory = v2.Definitions.ServerToClientEvent(), 
		EnableGlitchedMatch = v2.Definitions.ServerToClientEvent(), 
		CloneGlitchedLuckyBlock = v2.Definitions.ServerToClientEvent(), 
		ApplyBushDisguise = v2.Definitions.ServerToClientEvent(), 

-- Script Hash: 3864ab37fd0dece46c9cac6aa57430882123a4714efb9d28ba335a23ef31b577f7ef4b62eb74ce49b3c5678ab98ef386
-- Decompiled with the Synapse X Luau decompiler.

local v1 = _G[script];
local l__yieldForTree__1 = v1.import(script, v1.getModule(script, "@rbxts", "validate-tree")).yieldForTree;
local u2 = {
	["$className"] = "Model", 
	Head = {
		["$className"] = "MeshPart", 
...
local function v2(p1)
	return l__yieldForTree__1(p1, u3);
end;
return {
	yieldForR6CharacterDescendants = function(p2)
		return l__yieldForTree__1(p2, u2);
	end, 
	yieldForR15CharacterDescendants = v2, 
	CharacterRigR6 = u2, 
	CharacterRigR15 = u3, 
	default = v2
};

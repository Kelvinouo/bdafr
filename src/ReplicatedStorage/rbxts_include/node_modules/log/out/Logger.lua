-- Script Hash: 33d0c0be9ed401b201da5ce595442c5df347c2beaf8ccc64eca1b45b0f997768a869a202d99a1f9332a4b9b63d19bce0
		...
		if v13 <= #v5 and v16 ~= nil then
			if v15.destructureMode == l__DestructureMode__5.ToString then
				...
				if type(v16) == "table" then
					...
					v17 = l__RbxSerializer__6.Serialize(v16);
				end;
				v6[v15.propertyName] = v17;
			end;
		end;
	end;
	for v18, v19 in ipairs(p12.enrichers) do
		local v20 = {};
		v19:Enrich(v6, v20);
		for v21, v22 in pairs(v20) do
			if type(v22) == "table" then
				...
				v23 = l__RbxSerializer__6.Serialize(v22);
			end;
			v6[v21] = v23;
		end;
	end;
	for v24, v25 in ipairs(p12.sinks) do
		v25:Emit(v6);
	end;
...
function v3.Copy(p29)
	local v26 = l__LogConfiguration__2.new(v3.new());
	v26:SetMinLogLevel(p29:GetLevel());
	for v27, v28 in ipairs(p29.sinks) do
		v26:WriteTo(v28);
	end;
	for v29, v30 in ipairs(p29.enrichers) do
		v26:Enrich(v30);
	end;
	return v26;
end;
function v3.ForContext(p30, p31, p32)
	...
	return v31:EnrichWithProperties({
		SourceContext = v32, 
		SourceKind = "Context"
	}):Create();
end;
function v3.ForScript(p33, p34)
	...
	return v33:EnrichWithProperties({
		SourceContext = debug.info(2, "s"), 
		SourceKind = "Script"
	}):Create();
end;
function v3.ForFunction(p35, p36, p37)
	local v34, v35, v36 = debug.info(p36, "nls");
	local v37 = p35:Copy();
	if p37 ~= nil then
		p37(v37);
	end;
	...
	v38.SourceContext = "function '" .. v39 .. "'";
	v38.SourceLine = v35;
	v38.SourceFile = v36;
	v38.SourceKind = "Function";
	return v37:EnrichWithProperties(v38):Create();
end;
function v3.ForProperty(p38, p39, p40)
	return p38:Copy():EnrichWithProperty(p39, p40):Create();
end;
function v3.ForProperties(p41, p42)
	return p41:Copy():EnrichWithProperties(p42):Create();
end;

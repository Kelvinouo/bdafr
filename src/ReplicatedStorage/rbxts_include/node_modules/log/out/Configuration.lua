...
function v2.EnrichWithProperties(p15, p16, p17)
	local v6 = l__LogEventPropertyEnricher__4.new(p16);
	if p17 ~= nil then
		p17(v6);
	end;
	table.insert(p15.enrichers, v6);
	return p15;
end;
...
function v2.Create(p20)
	p20.logger:SetSinks(p20.sinks);
	p20.logger:SetEnrichers(p20.enrichers);
	p20.logger:SetMinLogLevel(p20.logLevel);
	return p20.logger;
end;
return {
	LogConfiguration = v2

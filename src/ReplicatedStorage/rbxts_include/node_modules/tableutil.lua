-- Script Hash: c573feb5d5e96b7de3b176efbc2177ac2e2c191fed88779b95d9a02388e2fc6d20ba8ef61fd8f916796b2fab6fd15204
...
function v1.Keys(p29)
	...
	for v48 in pairs(p29) do
		table.insert(v47, v48);
	end;
	return v47;
end;
function v1.Find(p30, p31)
	for v49, v50 in pairs(p30) do
		if p31(v50, v49, p30) then
			return v50, v49;
		end;
	end;
	return nil, nil;
...
function v1.Every(p32, p33)
	for v51, v52 in pairs(p32) do
		if not p33(v52, v51, p32) then
			return false;
		end;
	end;
	return true;
...
function v1.Some(p34, p35)
	for v53, v54 in pairs(p34) do
		if p35(v54, v53, p34) then
			return true;
		end;
	end;
	return false;

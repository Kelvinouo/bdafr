...
function v1.Reduce(p16, p17, p18)
	...
	assert(v32, "Third argument must be a number or nil");
	local v33 = p18 and 0;
	for v34, v35 in pairs(p16) do
		v33 = p17(v33, v35, v34, p16);
	end;
	return v33;
end;
function v1.Assign(p19, ...)
	local v36 = u1(p19);
	for v37, v38 in ipairs({ ... }) do
...
function v1.Shuffle(p23, p24)
	...
	local v48 = p24 or u5;
	for v49 = #p23, 2, -1 do
		local v50 = v48:NextInteger(1, v49);
		v47[v49] = v47[v50];
		v47[v50] = v47[v49];
	end;
	return v47;
...
function v1.Flat(p25, p26)
	p26 = p26 and 1;
	local v51 = table.create(#p25);
	local function u9(p27, p28)
		for v52, v53 in ipairs(p27) do
			if type(v53) == "table" and p28 < p26 then
				u9(v53, p28 + 1);
			else
...
function v1.FlatMap(p29, p30)
	local v54 = u6(p29, p30);
	local u10 = nil and 1;
	local u11 = table.create(#v54);
	local function u12(p31, p32)
		for v55, v56 in ipairs(p31) do
			if type(v56) == "table" and p32 < u10 then
				u12(v56, p32 + 1);
			else
				table.insert(u11, v56);
			end;
		end;
	end;
	u12(v54, 0);
...
function v1.Keys(p33)
	local v57 = table.create(#p33);
	for v58 in pairs(p33) do
		table.insert(v57, v58);
	end;
	return v57;
end;
function v1.Find(p34, p35)
	for v59, v60 in pairs(p34) do
		if p35(v60, v59, p34) then
			return v60, v59;
		end;
	end;
	return nil, nil;
...
function v1.Every(p36, p37)
	for v61, v62 in pairs(p36) do
		if not p37(v62, v61, p36) then
			return false;
		end;
	end;
	return true;
...
function v1.Some(p38, p39)
	for v63, v64 in pairs(p38) do
		if p39(v64, v63, p38) then
			return true;
		end;
	end;
	return false;

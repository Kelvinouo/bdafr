...
local u14 = math.cos(math.rad(90));
		...
		if v23.Enabled == true then
			...
			if v33 < (v23.PulseLength + 1) / v23.PulseSpeed then
				for v45 = 1, v27 do
					...
					if v45 ~= v27 then
						local v55 = (CFrame.new(v44, v54) * CFrame.Angles(0, 0, 0 + (0.2 * math.pi - 0) * v50 + (0 + (1.8 * math.pi - 0) * v51)) * CFrame.Angles(math.acos(math.clamp(u14 + (1 - u14) * (math.noise(v49, v48, 2.7) + 0.5), -1, 1)), 0, 0) * CFrame.new(0, 0, -((l__MinRadius__24 + (l__MaxRadius__25 - l__MinRadius__24) * v52) * v53))).Position or v54;
					else
						v55 = v54;
					end;

		...
		if v23.Enabled == true then
			...
			if v33 < (v23.PulseLength + 1) / v23.PulseSpeed then
				for v45 = 1, v27 do
					...
					local v50 = math.noise(5 * v48, 1.5, 1 * v49) + 0.5;
					local v51 = math.noise(0.5 * v48, 1.5, 0.1 * v49) + 0.5;
					local v52 = math.noise(3.4, v49, v48) + 0.5;
					local v53 = l__RadialProfileFunction__35(v47);
					local v54 = l__SpaceCurveFunction__34(v47, l__WorldPosition__38, v39, v40, l__WorldPosition__41);
					if v45 ~= v27 then
						local v55 = (CFrame.new(v44, v54) * CFrame.Angles(0, 0, 0 + (0.2 * math.pi - 0) * v50 + (0 + (1.8 * math.pi - 0) * v51)) * CFrame.Angles(math.acos(math.clamp(6.123233995736766E-17 + 0.9999999999999999 * (math.noise(v49, v48, 2.7) + 0.5), -1, 1)), 0, 0) * CFrame.new(0, 0, -((l__MinRadius__24 + (l__MaxRadius__25 - l__MinRadius__24) * v52) * v53))).Position or v54;
					else
						v55 = v54;
					end;
					v23:_UpdateGeometry(v46, v47, v33, l__MinThicknessMultiplier__31 + (l__MaxThicknessMultiplier__32 - l__MinThicknessMultiplier__31) * (math.noise(2.3, v49, v48) + 0.5), v43, v55);

-- Script Hash: eeb6767631c1770697f21c7d81732b0e35dfc30bdc4b0d35d72f2ddc20d4dd191a78fa24a33b7d31a216f4a297c84cca
...
function v1.join(p18, p19)
	return table.move(p19, 1, #p19, #p18 + 1, (table.create(#p18 + #p19)));
end;
function v1.removeObject(p20, p21)
	local v7 = v1.indexOf(p20, p21);
	if v7 then
		table.remove(p20, v7);
	end;
end;

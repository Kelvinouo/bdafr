...
local l__DestructureMode__6 = v2.DestructureMode;
u4 = function(p8, p9)
	p8 = p8 + 1;
	local v15 = u5(p8, p9, function(p10)
		return string.match(p10, "[@$]") ~= nil or string.match(p10, "[%w_]") ~= nil and p10 ~= "}";
	end);
	p8 = v15[1];
	local v16 = v15[2];
	if #p9 < p8 then
	...
	local v17 = l__DestructureMode__6.Default;
	local v18 = string.sub(v16, 1, 1);
	if string.match(v18, "[@$]") ~= nil then
		if v18 == "@" then
			v17 = l__DestructureMode__6.Destructure;
		elseif v18 == "$" then
			v17 = l__DestructureMode__6.ToString;
		else
			v17 = l__DestructureMode__6.Default;
		end;

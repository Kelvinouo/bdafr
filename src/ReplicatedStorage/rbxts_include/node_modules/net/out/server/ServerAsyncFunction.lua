...
v5.CallPlayerAsync = v1.async(function(p14, p15, ...)
	local v12 = l__HttpService__4:GenerateGUID(false);
	local v13 = {};
	...
	return v1.Promise.new(function(p16, p17)
		local v16 = tick();
		l__DebugLog__5("Connected CallPlayerAsync EventId", v12);
		local u8 = nil;
		u8 = p14.instance.OnServerEvent:Connect(function(p18, ...)
			local v17 = { ... };
			local v18 = v17[1];
			local v19 = v17[2];
			if type(v18) == "string" and v19 ~= nil and p15 == p15 and v18 == v12 then
				l__DebugLog__5("Disconnected CallPlayerAsync EventId", v18);
				u8:Disconnect();
				p16(v19);
			end;
		end);
		...
		if v16 <= tick() and u8.Connected then
			l__DebugWarn__7("(timeout) Disconnected CallPlayerAsync EventId", v12);
			u8:Disconnect();

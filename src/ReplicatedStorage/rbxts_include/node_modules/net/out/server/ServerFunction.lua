...
local l__findOrCreateRemote__1 = v2.findOrCreateRemote;
local l__IS_SERVER__2 = v2.IS_SERVER;
function v4.constructor(p1, p2, p3)
	if p3 == nil then
		p3 = {};
	end;
	l__default__3.constructor(p1, p3);
	p1.instance = l__findOrCreateRemote__1("RemoteFunction", p2, function(p4)
		p4.OnServerInvoke = v4.DefaultFunctionHook;
	end);
	assert(l__IS_SERVER__2, "Cannot create a Net.ServerFunction on the Client!");
end;

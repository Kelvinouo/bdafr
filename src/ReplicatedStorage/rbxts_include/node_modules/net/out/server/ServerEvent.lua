...
function v4.SendToAllPlayersExcept(p10, p11, ...)
	...
	local v15 = {};
	local v16 = 0;
	local v17, v18, v19 = ipairs((v8:GetPlayers()));
	while true do
		local v20, v21 = v17(v18, v19);
		if not v20 then
			break;
		end;
		if v21 ~= p11 == true then
			v16 = v16 + 1;
			v15[v16] = v21;
		end;	
	end;
	for v22, v23 in ipairs(v15) do
		p10.instance:FireClient(v23, unpack(v9));
	end;
end;
function v4.SendToPlayer(p12, p13, ...)
	...
	p12.instance:FireClient(p13, unpack({ ... }));
end;
function v4.SendToPlayers(p14, p15, ...)
	...
	for v25, v26 in ipairs(p15) do
		p14:SendToPlayer(v26, unpack(v24));
	end;
end;
function v4.DefaultEventHook(p16, ...)
	({})[1] = ...;
end;
u1 = {
	default = v4

-- Script Hash: 1152baf1b0277a098d6f9c18042d2a2280eb79ef0cfb3a459bf643b378c2711a68acd25fa8c996dfad432a3e82392c06
...
return function(p1)
	...
	local function u14(p9, p10)
		u8(p9);
		local v20 = u9(p10, p9.hostParent, p9.hostKey, p9.originalContext or p9.context, p9.parentLegacyContext);
		if v20 ~= nil then
			v20.depth = p9.depth;
			v20.parent = p9.parent;
		end;
		return v20;
	end;
	...
	local function u17(p16, p17)
		local l__target__21 = p17.props.target;
		assert(p1.isHostObject(l__target__21), "Expected target to be host object");
		if l__target__21 ~= p16.currentElement.props.target then
			return u14(p16, p17);
		end;
		u15(p16, l__target__21, p17.props[u6]);
		return p16;
	end;
	...
	u10 = function(p20, p21, p22)
		...
		elseif v23 == u5.Function then
			p20 = u16(p20, p21);
		elseif v23 == u5.Stateful then
			v24 = p20.instance:__update(p21, p22);
		elseif v23 == u5.Portal then
			p20 = u17(p20, p21);
		elseif v23 == u5.Fragment then
			p20 = u18(p20, p21);
		else
	...
	local function u19(p23, p24, p25, p26, p27)
		if u1.internalTypeChecks then
			...
			u2(v25, "Expected arg #4 to be of type table or nil");
			local v26 = true;
			if typeof(p27) ~= "table" then
				v26 = p27 == nil;
			end;
			u2(v26, "Expected arg #5 to be of type table or nil");
		end;
		if u1.typeChecks then
			assert(p25 ~= nil, "Expected arg #3 to be non-nil");
			local v27 = true;
			if u3.of(p23) ~= u3.Element then
				v27 = typeof(p23) == "boolean";
			end;
			assert(v27, "Expected arg #1 to be of type Element or boolean");
		end;
		return {
			[u3] = u3.VirtualNode, 
			currentElement = p23, 
	...
	local function u20(p28)
		local l__currentElement__28 = p28.currentElement;
		u13(p28, p28.hostParent, (l__currentElement__28.component(l__currentElement__28.props)));
	end;
	local function u21(p29)
		local l__currentElement__29 = p29.currentElement;
		local l__target__30 = l__currentElement__29.props.target;
		assert(p1.isHostObject(l__target__30), "Expected target to be host object");
		u15(p29, l__target__30, l__currentElement__29.props[u6]);
	end;
	...
	u9 = function(p31, p32, p33, p34, p35)
		...
		if u1.internalTypeChecks then
			...
			u2(v32, "Expected arg #5 to be of type table or nil");
		end;
		if u1.typeChecks then
			assert(p33 ~= nil, "Expected arg #3 to be non-nil");
			local v33 = true;
			if u3.of(p31) ~= u3.Element then
				v33 = typeof(p31) == "boolean";
			end;
			assert(v33, "Expected arg #1 to be of type Element or boolean");
		end;
		if typeof(p31) == "boolean" then
			return nil;
		end;
		local v34 = u5.of(p31);
		v31 = u19(p31, p32, p33, p34, p35);
		if v34 == u5.Host then
			p1.mountHostNode(u12, v31);
			return v31;
		end;
		if v34 == u5.Function then
			u20(v31);
			return v31;
		end;
		if v34 == u5.Stateful then
			p31.component:__mount(u12, v31);
			return v31;
		end;
		if v34 == u5.Portal then
			u21(v31);
			return v31;
		end;
		if v34 == u5.Fragment then
			u22(v31);
			return v31;
		end;
	...
	u12 = {
		mountVirtualTree = function(p36, p37, p38)
			...
			v35[u7].rootNode = u9(p36, p37, p38);
			return v35;
		end, 
		unmountVirtualTree = function(p39)
			...
			if u1.typeChecks then
				...
				assert(v36.mounted, "Cannot unmounted a Roact tree that has already been unmounted");
			end;
			v36.mounted = false;
			if v36.rootNode ~= nil then
				u8(v36.rootNode);
			end;
		end, 
		updateVirtualTree = function(p40, p41)
			...
			v37.rootNode = u10(v37.rootNode, p41);
			return p40;
		end, 
		...
		suspendParentEvents = function(p42)
			local v38 = p42.parent;
			while v38 do
				if v38.eventManager ~= nil then
					v38.eventManager:suspend();
				end;
				v38 = v38.parent;			
			end;
		end, 
		resumeParentEvents = function(p43)
			local v39 = p43.parent;
			while v39 do
				if v39.eventManager ~= nil then
					v39.eventManager:resume();
				end;
				v39 = v39.parent;			
			end;
		end

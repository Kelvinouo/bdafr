-- Script Hash: 9c951818c6ce37a638e159477f8b0be6135aebccadae8217465bde25afdd0333ec264b95912b844db2b36fb9c9005e75
...
return {
	...
	yieldForTree = v1.async(function(p5, p6)
		...
		return v1.await(v1.Promise.new(function(p7, p8, p9)
			...
			for v21, v22 in ipairs(p5:GetDescendants()) do
				u3[#u3 + 1] = v22:GetPropertyChangedSignal("Name"):Connect(v20);
			end;
			...
			u4:andThen(function()
				...
				if not v20(v23) then
					...
					warn("[yieldForTree] Infinite yield possible. Waiting for: " .. table.concat(v23, v24));
				end;
			end);
		end));
	end)

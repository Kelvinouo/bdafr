-- Script Hash: ca046b01ed74a5316591d9a4ac961c0d6ca3993bd86ed4e2b1997579009e2884ccb191a0fd8e49028fab31ea2e561acf
...
function v1.tuple(...)
	...
	return function(...)
		local v13 = { ... };
		for v14, v15 in ipairs(u6) do
			if v15(v13[v14]) == false then
				return false;
			end;
		end;
		return true;
...
function v1.values(p32)
	...
	return function(p33)
		...
		for v18, v19 in pairs(p33) do
			if p32(v19) == false then
				return false;
			end;
		end;
		return true;
...
function v1.array(p38)
	...
	return function(p39)
		...
		local v20 = 0;
		for v21, v22 in ipairs(p39) do
			v20 = v20 + 1;
		end;
		for v23, v24 in pairs(p39) do
			if v23 < 1 then
				return false;
			end;
			if v20 < v23 then
...
function v1.strictArray(...)
	local v25 = { ... };
	assert(v1.array(v1.callback)(v25));
	return function(p40)
...
function v1.interface(p43)
	...
	return function(p44)
		...
		for v34, v35 in pairs(p43) do
			if v35(p44[v34]) == false then
				return false;
			end;
		end;
		return true;
...
function v1.strictInterface(p45)
	...
	return function(p46)
		...
		for v36, v37 in pairs(p45) do
			if v37(p46[v36]) == false then
				return false;
			end;
		end;
		for v38, v39 in pairs(p46) do
			if not p45[v38] then
				return false;
			end;
		end;
...
function v1.children(p58)
	...
	return function(p59)
		...
		local v42 = {};
		for v43, v44 in ipairs(p59:GetChildren()) do
			local l__Name__45 = v44.Name;
			if p58[l__Name__45] then
				if v42[l__Name__45] then
					return false;
				end;
				v42[l__Name__45] = v44;
			end;
		end;
		for v46, v47 in pairs(p58) do
			if not v47(v42[v46]) then
				return false;
			end;
		end;
		return true;

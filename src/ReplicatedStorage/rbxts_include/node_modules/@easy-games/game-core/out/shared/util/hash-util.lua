...
function v42.constructor(p20, p21)
	...
	while true do
		...
		local v52 = v50 + 1;
		v44[v52] = bit32.bxor(v44[v52], 106);	
	end;
...
function v1.hmac(p30, p31)
	local v62 = v42.new(p30):update(p31);
	local v63 = v62:digest();
	v62:clean();
	return v63;
end;
...
function v1.hkdf(p36, p37, p38, p39)
	...
	local v65 = table.create(1, 0);
	table.insert(v65, 1);
	local v66 = v42.new(p37):update(p36);
	local v67 = v66:digest();
	v66:clean();
	local v68 = v42.new(v67);
	local v69 = table.create(v68.digestLength, 0);
	local v70 = #v69;
	local v71 = table.create(p39, 0);
	local v72 = 0;
	local v73 = false;
	while true do
		if v73 then
	...
	while #v65 < v68.digestLength do
		table.insert(v69, 0);	
	end;
	return v71;
end;
function v1.pbkdf2(p40, p41, p42, p43)
	local v76 = v42.new(p40);
	local l__digestLength__77 = v76.digestLength;
	local v78 = table.create(4, 0);
	local v79 = table.create(l__digestLength__77, 0);
	local v80 = table.create(l__digestLength__77, 0);
	local v81 = table.create(p43, 0);
	local v82 = 0;
	local v83 = false;
	while true do
		if v83 then
		...
		if not (v82 * l__digestLength__77 < p43) then
			break;
		end;
		local v84 = v82 + 1;
		v78[1] = bit32.band(bit32.rshift(v84, 24), 255);
		v78[2] = bit32.band(bit32.rshift(v84, 16), 255);
		v78[3] = bit32.band(bit32.rshift(v84, 8), 255);
		v78[4] = bit32.band(bit32.rshift(v84, 0), 255);
		v76:reset();
		v76:update(p41);
		v76:update(v78);
		v76:finish(v80);
		...
		while true do
			...
			if not (v85 < l__digestLength__77) then
				break;
			end;
			v79[v85 + 1] = v80[v85 + 1];		
		end;
		...
		while true do
			...
			while true do
				...
				if not (v89 < l__digestLength__77) then
					break;
				end;
				local v91 = v89 + 1;
				v79[v91] = bit32.bxor(v79[v91], v80[v89 + 1]);			
			end;		
		end;
		local v92 = 0;
		local v93 = false;
		while true do
			...
			if not (v92 < l__digestLength__77) then
				break;
			end;
			if not (v82 * l__digestLength__77 + v92 < p43) then
				break;
			end;
			v81[v82 * l__digestLength__77 + v92 + 1] = v79[v92 + 1];		
		end;	
	end;
	local v94 = 0;
	local v95 = false;
	while true do
		...
		if not (v94 < l__digestLength__77) then
			break;
		end;
		local v96 = v94 + 1;
		v80[v96] = 0;

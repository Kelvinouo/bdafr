...
function v4.reconcileModifiers(p10)
	...
	local v8 = u4.values(p10.modifiers);
	...
	if p10.config.behavior == v3.Merge then
		...
		while true do
			...
			v12 = v10;
			for v13, v14 in pairs(v11:getProperties()) do
				if v9[v13] == nil then
					v9[v13] = v14;
				end;
			end;		
	...
	l__default__3.Info("Applying new properties to instance {@Instance}: {@Properties}", p10.instance, v9);
	for v21, v22 in pairs(v9) do

...
function v4.didUpdate(p5, p6)
	local v7 = -1;
	local v8, v9, v10 = ipairs(p5.props.Notifications.notifications);
	while true do
		v8(v9, v10);
		if not v8 then
			break;
	...
	local v11 = p5:getHeight() * 1.2 * v7;
	p5.positionMaid:DoCleaning();
	local v12 = l__TweenService__2:Create(p5.frameRef:getValue(), TweenInfo.new(0.2), {
		Position = UDim2.new(0.5, 0, 1, -v11)
	});
	v12:Play();
...
function v4.render(p7)
	...
	local v15 = #v14;
	local v16 = p7.props[v2.Children];
	if v16 then
	...
	return v2.createElement("Frame", v13, v14);
end;
return {
	NotificationCard = v1.import(script, v1.getModule(script, "@rbxts", "roact-rodux").src).connect(function(p8, p9)
		...
		v22.Notifications = p8.Notifications;
		return v22;
	end, function(p10)
		local v25 = {};
		function v25.removeNotification(p11, p12)
			p10({

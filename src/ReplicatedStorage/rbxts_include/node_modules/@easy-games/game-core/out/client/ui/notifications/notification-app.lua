...
function v4.didUpdate(p3, p4)
	if p4.Notifications.notifications ~= p3.props.Notifications.notifications then
		local v5, v6, v7 = ipairs(p3.props.Notifications.notifications);
		while true do
			v5(v6, v7);
			if not v5 then
				break;
			...
			if p3.notifs[v6.uniqueId] == nil then
				local v8 = {};
				for v9, v10 in pairs(v6.componentProps) do
					v8[v9] = v10;
				end;
				v8.uniqueId = v6.uniqueId;
				local v11 = {};
				local v12 = {};
				local v13 = {};
				...
				v12[#v12 + 1] = v2.createElement(v6.component, v13);
				v11[#v11 + 1] = v2.createElement(l__NotificationCard__2, {
				...
				}, v11), p3.frameRef:getValue());
			end;		
		end;
		local v16, v17, v18 = ipairs(u4.keys(p3.notifs));
		while true do
			v16(v17, v18);
			if not v16 then
				break;
			...
			local v19 = false;
			local v20, v21, v22 = ipairs(p3.props.Notifications.notifications);
			while true do
				v20(v21, v22);
				if not v20 then
					break;
				...
				v22 = v20;
				if v21.uniqueId == v17 then
					v19 = true;
					break;
				end;			
			end;
			if not v19 then
				local v23 = p3.notifs[v17];
				if v23 then
					v2.unmount(v23);
				end;
				p3.notifs[v17] = nil;

...
local l__GameCoreNetEvents__2 = v3.GameCoreNetEvents;
...
local l__GameCoreNetFunctions__7 = v3.GameCoreNetFunctions;
function v4.regenCodes(p4, p5)
	local l__UserId__6 = l__Players__4.LocalPlayer.UserId;
	if p4.rateLimiter:has(l__UserId__6) then
...
function v4.redeemCode(p7, p8)
	...
	p7.rateLimiter:add(l__UserId__7);
	return l__GameCoreNetFunctions__7.client.redeemCode:invoke(p8);
end;
function v4.requestCodeGenUpdate(p10)
	l__GameCoreNetEvents__2.client.requestCodeGenUpdate:fire();
end;
l__Reflect__2.defineMetadata(v4, "identifier", "@easy-games/game-core:client/controllers/game-codes/game-codes-controller@GameCodesController");

-- Script Hash: 892101b3cd023238ff75e7f8b4f0f6ddf15c5c11e0aa5e3d44179ecb5e39c869d6b5e4c924186e1502aa62711d0dfcea
...
local l__Stats__4 = v4.Stats;
function v5.onReportMetrics(p3)
...
l__Reflect__2.defineMetadata(v5, "identifier", "@easy-games/game-core:client/controllers/metrics/performance-metrics-controller@PerformanceMetricsController");
...
return {
	PerformanceMetricsController = v5
};

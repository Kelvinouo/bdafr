...
function v5.hookPortal(p9, p10)
	...
	p10.Touched:Connect(function(p11)
		...
		local v22 = l__Players__11:GetPlayerFromCharacter(v21);
		if not v22 or v22 ~= l__Players__11.LocalPlayer then
			return nil;
		end;
...
function v5.spawnPixelParticle(p16, p17, p18)
	...
	while true do
		...
		v34.Force = Vector3.new(0, v33:GetMass() * l__Workspace__12.Gravity / 1.3, 0);
		v34.Parent = v33;

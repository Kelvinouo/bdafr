-- Script Hash: 706a1725c291e887081cacc5a64b97d1f36b0efd40dc0eb8e4228cbcd278bd01fc103059c696b74f6d5634a468947000
...
local l__TeleportService__11 = v4.TeleportService;
function v5.hookPortal(p9, p10)
	...
	p10.Touched:Connect(function(p11)
		...
		local v22 = l__Players__9:GetPlayerFromCharacter(v21);
		if not v22 or v22 ~= l__Players__9.LocalPlayer then
			return nil;
		end;
...
function v5.spawnPixelParticle(p16, p17, p18)
	...
	while true do
		...
		v34.Force = Vector3.new(0, v33:GetMass() * l__Workspace__10.Gravity / 1.3, 0);
		v34.Parent = v33;

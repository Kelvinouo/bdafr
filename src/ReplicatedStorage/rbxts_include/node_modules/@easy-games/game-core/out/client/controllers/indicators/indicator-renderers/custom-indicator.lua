-- Script Hash: 9b9956dd8d87cf3c4933f9d37ac5316b24535853a4c34a13959573917505b00ad76f05806cbf1fe938216daa84d280c2
...
function v2.updateProperties(p2, p3, p4, p5)
	...
	p2.ui.Size = (p2.config.size or l__ActiveWorldIndicator__1.BASE_INDICATOR_SIZE):Lerp(UDim2.new(), v10);
	if p2.arrow then

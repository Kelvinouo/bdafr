...
function v5.getIndicator(p5, p6)
	local v10 = p5.activeIndicators[p6];
end;
function v5.removeIndicator(p7, p8)
	p7.activeIndicators[p8] = nil;
end;
function v5.onRender(p9)
	for v11, v12 in pairs(p9.activeIndicators) do
		v12:update();
	end;
end;
function v5.updateUiContainer(p10)
	local l__ViewportSize__13 = l__CurrentCamera__1.ViewportSize;
	local v14 = math.min(l__ViewportSize__13.X, l__ViewportSize__13.Y) * 0.065;
	p10.uiContainer.Position = UDim2.fromOffset(v14, v14);
	p10.uiContainer.Size = UDim2.new(1, -v14 * 2, 1, -v14 * 2);
end;
local u7 = v1.import(script, v1.getModule(script, "@rbxts", "make"));
local l__Players__8 = v4.Players;
function v5.createUiContainer(p11)
	local v15 = u7("Frame", {

-- Script Hash: 08a492644b482cc992f39bf602ca368b1eb04860f9f6c05e5b184f8b40e535064a675070d32cf8e9d4a67618696ae6f7
...
function v4.updateViewport(p2)
	...
	local v19, v20 = v7:GetBoundingBox();
...
function v4.rotateKit(p6, p7)
	...
	local v23 = l__TweenService__3:Create(p7.PrimaryPart, v22, {
		CFrame = p7.PrimaryPart.CFrame * CFrame.Angles(0, math.rad(120), 0)
	});
	local v24 = l__TweenService__3:Create(p7.PrimaryPart, v22, {
		CFrame = p7.PrimaryPart.CFrame * CFrame.Angles(0, math.rad(240), 0)
	});
	local v25 = l__TweenService__3:Create(p7.PrimaryPart, v22, {

-- Script Hash: c203f976a30d6f692294072b778025cb046f55e7efdcad1fc5876d87a27c06fddde73328d245d153d12ef8ae9be76d00
...
function v5.onStart(p2)
	...
	l__WatchPlayer__3(function(p5, p6)
		...
		p6:GiveTask(p5.OnTeleport:Connect(function(p8, p9)
			...
			if table.find(l__GameCoreServerConfig__6.SessionExcludePlaceIds, p9) ~= nil then
				return nil;
			end;
			if not u7 then

-- Script Hash: bd8c37f1e4fdb2805d343ceccf013ce6d0dc97a8fc4a19c9326ac33937ee674b1a52c56098e0a3831adc1f4cec2adc81
...
if v4.RunService:IsStudio() then
	local v5 = 1;
else
	v5 = 0.1;
end;
...
function v6.onStart(p3)
	...
	l__WatchPlayer__2(function(p6)
		local l__playerJoinTimes__8 = p3.playerJoinTimes;
		l__playerJoinTimes__8[p6] = os.clock();
		return l__playerJoinTimes__8;
	end);
...
function v6.registerMetricModifier(p8, p9)

...
function v5.constructor(p1)
	p1.permissions = {
		...
		[3361695884] = { l__Permission__1.ADMIN, l__Permission__1.FREECAM }, 
		[308165] = { l__Permission__1.ADMIN, l__Permission__1.FREECAM }, 
...
function v5.playerHasAllPermissions(p9, p10, p11)
	...
	while true do
		...
		v25 = v23;
		if table.find(v22, v24) == nil then
			return false;
		end;	
	end;
	return true;
end;
function v5.playerHasAnyPermission(p12, p13, p14)
	local v26 = p12:getPlayerPermissions(p13);
	if v26 == nil then
		return false;
	end;
	local v27, v28, v29 = ipairs(p14);
	while true do
		v27(v28, v29);
		if not v27 then
			break;
		...
		v29 = v27;
		if table.find(v26, v28) ~= nil then
			return true;
		end;	
	end;
	return false;
...
function v5.playerIsInPermissionGroup(p15, p16, p17)
	if p17.type == l__PermissionGroupType__4.ALL then
		return p15:playerHasAllPermissions(p16, p17.permissions);
	end;
	if p17.type == l__PermissionGroupType__4.ANY then
		return p15:playerHasAnyPermission(p16, p17.permissions);
	end;
	if p17.type == l__PermissionGroupType__4.EVERYONE then
		return true;
	end;
	return false;
end;

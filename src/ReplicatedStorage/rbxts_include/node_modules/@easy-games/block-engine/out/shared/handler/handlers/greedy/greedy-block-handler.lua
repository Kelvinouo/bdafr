-- Script Hash: e4c12e9d7c2146ad584916cb1d3d3684485459b77c95195ad2e76934de9222228868b5849322610d856f7798d48aa2f6
...
function v3.createNewInstance(p33, p34)
	...
	local v40 = p33.blockMeta.greedyMesh.material;
	if v40 == nil then
		v40 = Enum.Material.Fabric;
	end;
	v39.Material = v40;
	v39.Color = p33.blockMeta.greedyMesh.materialColor;
	v39.CanCollide = true;
	v39.Anchored = true;
	local v41 = u4("Part", v39);
	for v42, v43 in ipairs(Enum.NormalId:GetEnumItems()) do
		p33:createFace(v41, p34, v43).Parent = v41;
	end;
	return v41;
end;

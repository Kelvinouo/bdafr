...
function v10.getMouseInfo(p3, p4, p5)
	...
	if p4 == v9.PLACE then
		...
		local v47 = {};
		local v48 = 0;
		for v49, v50 in ipairs((l__Players__1:GetPlayers())) do
			local l__Character__51 = v50.Character;
			if l__Character__51 ~= nil then
				v48 = v48 + 1;
				v47[v48] = l__Character__51;
			end;
		end;
		local v52 = {};
		table.move(v47, 1, #v47, #v52 + 1, v52);
		v13.FilterDescendantsInstances = v52;
		local v53 = p5;
		if v53 ~= nil then
			v53 = v53.searchOutward;
		end;
		if v53 then
			v13.FilterDescendantsInstances = { v46 };
		...
		if v55 == v46 then
			local v56 = l__BlockEngine__5:getBlockPosition(l__BlockEngine__5:snapPosition(v54.Position - v33 * (l__BLOCK_SIZE__6 / 2)));
			local v57 = v32.blockPosition;
			if l__BlockEngine__5:getStore():getBlockAt(v57) then
				local v58 = 0;
				local v59 = false;
				while true do
					if v59 then
					...
					v57 = v57 + (v56 - v57).Unit / 2;
					if not l__BlockEngine__5:getStore():getBlockAt(l__BlockEngine__5:snapPosition(v57)) then
						break;
					end;				
				end;
			end;
			local v60 = l__BlockEngine__5:snapPosition(v57);
			if l__BlockEngine__5:getStore():getBlockAt(v60) == nil then
				return {
					target = nil, 
					placementPosition = v60
				};
			end;
		end;
	end;

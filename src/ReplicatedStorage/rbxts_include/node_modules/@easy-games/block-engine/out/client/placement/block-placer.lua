...
function v4.constructor(p1, p2, p3)
	...
	l__BlockEngineRemotes__5.Client:WaitFor("PlaceBlockEvent"):andThen(function(p4)
...
function v4.placeBlock(p10, p11)
	...
	v1.try(function()
		l__BlockEngineRemotes__5.Client:Get("PlaceBlock"):CallServer({
...
function v4.autoBridge(p19)
	...
	local v13 = p19.clientManager:getBlockSelector():getMouseInfo(l__BlockSelectorMode__4.PLACE, {
		ray = Ray.new(v12.CFrame.Position, ((v12.CFrame + Vector3.new(0, u17.AUTOBRIDGE_Y_OFFSET, 0)) * CFrame.Angles(math.rad(-15), 0, 0)).LookVector)
	});
	if v13 then
		p19:placeBlock(v13.placementPosition);
	end;
end;
function v4.disable(p20)
	p20.maid:DoCleaning();
end;
function v4.getBlockType(p21)
	return p21.blockType;
end;
return {
	BlockPlacer = v4
};

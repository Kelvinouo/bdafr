...
function v4.autoBridge(p19, p20)
	...
	local v26 = p19.clientManager:getBlockSelector():getMouseInfo(l__BlockSelectorMode__4.PLACE, {
		ray = Ray.new(v13.CFrame.Position + Vector3.new(0, u17.AUTOBRIDGE_Y_OFFSET, 0), (v17 * CFrame.Angles(-0.2617993877991494, 0, 0)).LookVector), 
		searchOutward = true, 
		allowVoidSave = p20
	});
	if v26 then
		p19:placeBlock(v26.placementPosition);
	end;
end;

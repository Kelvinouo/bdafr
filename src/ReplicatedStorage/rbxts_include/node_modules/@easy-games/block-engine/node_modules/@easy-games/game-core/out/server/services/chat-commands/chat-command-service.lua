-- Script Hash: f3ff8b6ea318a6c10756c72fa4969fe3b8ce07014a0df1e71be06c19a01a39533ea0d89b137a2cfec0c704cc7aa4b250
...
function v4.onStart(p3)
	p3.luaChatService:RegisterProcessCommandsFunction("chat-command-service", function(p4, p5, p6)
		local v9 = l__Players__3:GetPlayers();
		local function v10(p7)
			return p7.Name == p4;
		end;
		local v11 = nil;
		for v12, v13 in ipairs(v9) do
			if v10(v13, v12 - 1, v9) == true then
				v11 = v13;
				break;
			end;
		end;
		...
		for v20, v21 in ipairs(v15) do
			if v17(v21, v20 - 1, v15) == true then
				v19 = v19 + 1;
				v18[v19] = v21;
			end;
		end;
					...
					if v26 ~= nil then
						...
						if v27 ~= false then
							...
							if l__Flamework__4._implements(v25, "@easy-games/game-core:server/services/chat-commands/chat-command-service@CanUseCommandOverride") then
								v30 = v25:canUseCommandOverride(v11);
							end;
							if not (not v30) or not (not l__RunService__5:IsStudio()) or l__Flamework__4.resolveDependency("@easy-games/game-core:server/services/permissions/permission-service@PermissionService"):playerIsInPermissionGroup(v11, v26.permissionGroup) then
								if l__Flamework__4._implements(v25, "@easy-games/game-core:server/services/chat-commands/chat-command-service@OnCommandRun") then
									v25:onRun(v11, string.lower(v16), unpack(v18));
								end;
								v14 = v26.hidden;
							end;
						end;

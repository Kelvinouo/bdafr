-- Script Hash: e9ce2b81a787c4106ac682aa1b729024bbc9b5b167598e4c6dab4c5b47b0a03db25ed082e52c6179cb7b239da1eb5ff5
...
function v2.constructor(p1, p2, p3, p4)
	...
	if v12 then
		for v13, v14 in ipairs(u4.keys(p4.uiThemeOverrides)) do
			if l__GameTheme__5[v14] ~= nil then
				l__GameTheme__5[v14] = p4.uiThemeOverrides[v14];
			end;
		end;
	end;
end;

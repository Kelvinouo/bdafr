...
function v4.playerHasAllPermissions(p9, p10, p11)
	...
	for v22, v23 in ipairs(p11) do
		if table.find(v21, v23) == nil then
			return false;
		end;
	end;
	return true;
end;
function v4.playerHasAnyPermission(p12, p13, p14)
	local v24 = p12:getPlayerPermissions(p13);
	if v24 == nil then
		return false;
	end;
	for v25, v26 in ipairs(p14) do
		if table.find(v24, v26) ~= nil then
			return true;
		end;
	end;
	return false;
...
function v4.playerIsInPermissionGroup(p15, p16, p17)

-- Script Hash: 7f509e105d81d2c1e9544103d736696954fa1780b9e43ac8b1bbf81fa30c3e8b4474cb05ab44a2f77a34da91e8bdc55e
...
function v3.playSound(p14, p15, p16)
	...
	if v46 then
		...
		if not v48 then
			...
			v50.CanQuery = false;
			v50.Transparency = 1;
			v50.Parent = p14.workspaceSoundsFolder;
			v48 = u1("Part", v50);
...
function v3.tweenSoundVolume(p17, p18, p19, p20, p21)
	...
	local v57 = l__TweenService__5:Create(p18, TweenInfo.new(p20, v54, v56), {
		Volume = p19
	});
	v57:Play();
	return v57;

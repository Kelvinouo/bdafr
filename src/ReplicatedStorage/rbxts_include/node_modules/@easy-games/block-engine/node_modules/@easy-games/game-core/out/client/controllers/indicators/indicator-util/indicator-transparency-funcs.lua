-- Script Hash: 66df3da9fa2b83ddb3fb6a2eeaa195bb9d745113b58abffe054e66048f197264f5c6cc7fa7cc9ac0eb99bbde7908029c
...
function v2.combine(p14, ...)
	local u4 = { ... };
	return function(p15)
		local function v4(p16)
			return p16(p15);
		end;
		local v5 = table.create(#u4);
		for v6, v7 in ipairs(u4) do
			v5[v6] = v4(v7, v6 - 1, u4);
		end;
		return math.max(unpack(v5));
	end;
end;
return {

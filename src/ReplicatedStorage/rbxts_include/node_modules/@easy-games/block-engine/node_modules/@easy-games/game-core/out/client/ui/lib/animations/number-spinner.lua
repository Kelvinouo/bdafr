-- Script Hash: ebeb9759dd18eb1e64a6d7aac9c8a7bd7cbc14380ba1a62695592ac8464e792762bb7e75d20524d926c8b0ec584011f4
...
local function u6()
	...
	function u7.Update(p7, p8, p9)
		...
		if not v23 then
			...
			for v34, v35 in ipairs(u7.Digits.Decimal) do
				v35:Destroy();
			end;
		...
		for v36 = 1, #v23 do
			local v37 = u7.Digits.Decimal[v36];
			if v37 then
				v37.Duration = u7.Duration;
				v37.Value = tonumber(string.sub(v23, v36, v36));
			else
				u7.Digits.Decimal[v36] = v37;
			end;
		end;
		for v38 = #v23 + 1, #u7.Digits.Decimal do
			local v39 = u7.Digits.Decimal[v38];
			if v39 then
				v39:Destroy();
				u7.Digits.Decimal[v38] = nil;
			end;
		end;
	end;
	return u8, u7;
...
function v2.new()
	...
	v43.FillDirection = Enum.FillDirection.Horizontal;
	v43.HorizontalAlignment = Enum.HorizontalAlignment.Center;
	v43.VerticalAlignment = Enum.VerticalAlignment.Center;
	v43.Padding = UDim.new(0, 1);
	v43.Parent = v42;
	local v44 = Instance.new("TextLabel");
	v44.Name = "Prefix";
	v44.LayoutOrder = -1000;
	v44.BackgroundTransparency = 1;
	v44.Size = UDim2.new(0, 0, 1, 0);
	v44.Font = v40.Font;
	v44.TextSize = v40.TextSize;
	v44.TextColor3 = v40.TextColor3;
	v44.Text = v40.Prefix;
	...
	v45.Font = v40.Font;
	v45.TextSize = v40.TextSize;
	v45.TextColor3 = v40.TextColor3;
	v45.Text = v40.Suffix;
	...
	v46.Font = v40.Font;
	v46.TextSize = v40.TextSize;
	v46.TextColor3 = v40.TextColor3;
	v46.Text = ".";
	...
	v47.Font = v40.Font;
	v47.TextSize = v40.TextSize;
	v47.TextColor3 = v40.TextColor3;
	v47.Text = "-";
	...
	v41.PrefixLabel = v44;
	v41.SuffixLabel = v45;
	v41.DecimalLabel = v46;
	v41.NegativeLabel = v47;
	v40:Update();
	return v40;
end;
function v2.fromGuiObject(p10)
	...
	local v48 = v2.new();
	v48.Name = "Spinner_" .. p10.Name;
	v48.SizeConstraint = p10.SizeConstraint;
	v48.Size = p10.Size;
	v48.Position = p10.Position;
	v48.AnchorPoint = p10.AnchorPoint;
	v48.Rotation = p10.Rotation;
	v48.LayoutOrder = p10.LayoutOrder;
	v48.ZIndex = p10.ZIndex;
	v48.Visible = p10.Visible;
	v48.BackgroundColor3 = p10.BackgroundColor3;
	v48.BorderColor3 = p10.BorderColor3;
	v48.BorderSizePixel = p10.BorderSizePixel;
	v48.BackgroundTransparency = p10.BackgroundTransparency;
	if not (not p10:IsA("TextLabel")) or not (not p10:IsA("TextButton")) or p10:IsA("TextBox") then
		v48.Font = p10.Font;
		v48.TextSize = p10.TextSize;
		v48.TextColor3 = p10.TextColor3;
		v48.TextTransparency = p10.TextTransparency;
		v48.TextStrokeColor3 = p10.TextStrokeColor3;
		v48.TextStrokeTransparency = p10.TextStrokeTransparency;
		v48.Layout.HorizontalAlignment = u3[p10.TextXAlignment];
	end;
	v48.Parent = p10.Parent;
	p10.Visible = false;
	return v48;
end;
return {

-- Script Hash: dc26c42a292cc644ea9fb49aafa18b64d1d1689c08b889fadab8586ae129574211273d25ab1b8967a80c6d5f95ce6c21
...
v3.getFriends = v1.async(function(p8)
...
v3.fuzzySearchFriends = v1.async(function(p9, p10)
	local u6 = {};
	...
	return v1.await(p9:getFriends():andThen(function(p11)
		...
		local function v12(p12)
			return table.find(u6, p12) == nil;
		end;
		local v13 = {};
		local v14 = 0;
		for v15, v16 in ipairs(p11) do
			if v12(v16, v15 - 1, p11) == true then
				v14 = v14 + 1;
				v13[v14] = v16;
			end;
		end;
		local function v17(p13)
			return string.lower(p13.username) == u7;
		end;
		local v18 = {};
		local v19 = 0;
		...
		local function v25(p15)
			return table.find(u6, p15) == nil;
		end;
		local v26 = {};
		local v27 = 0;
		for v28, v29 in ipairs(p11) do
			if v25(v29, v28 - 1, p11) == true then
				v27 = v27 + 1;
				v26[v27] = v29;
			end;
		end;
		local function v30(p16)
			return u5.startsWith(string.lower(p16.username), u7);
		end;
		local v31 = {};
		local v32 = 0;
		...
		local function v38(p18)
			return table.find(u6, p18) == nil;
		end;
		local v39 = {};
		local v40 = 0;
		for v41, v42 in ipairs(p11) do
			if v38(v42, v41 - 1, p11) == true then
				v40 = v40 + 1;
				v39[v40] = v42;
			end;
		end;
		local function v43(p19)
			return u5.includes(string.lower(p19.username), u7);
		end;
		local v44 = {};
		local v45 = 0;
...
l__Reflect__2.defineMetadata(v3, "identifier", "@easy-games/game-core:client/controllers/friends/friends-controller@FriendsController");

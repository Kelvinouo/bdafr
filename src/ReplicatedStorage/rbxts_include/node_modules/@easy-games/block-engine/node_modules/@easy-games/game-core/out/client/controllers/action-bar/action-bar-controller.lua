-- Script Hash: 9ae90913196c1120b1b7d336072b2b9790762e08386486b55da6dacdb22d88d2c2b3127ab9a21d6114335a220a758b05
...
function v4.addComponent(p13, p14)
	...
	if not v25 then
		...
		v24:GiveTask(function()
			local l__childElementQueue__26 = p13.childElementQueue;
			local function v27(p15)
				return p15.component ~= p14;
			end;
			local v28 = {};
			local v29 = 0;
			for v30, v31 in ipairs(l__childElementQueue__26) do
				if v27(v31, v30 - 1, l__childElementQueue__26) == true then
					v29 = v29 + 1;
					v28[v29] = v31;
				end;
			end;
			p13.childElementQueue = v28;
		end);
		return v24;
	end;
	print("Mounted a component normal way...");
	local v32 = u1.mount(p14, v25);

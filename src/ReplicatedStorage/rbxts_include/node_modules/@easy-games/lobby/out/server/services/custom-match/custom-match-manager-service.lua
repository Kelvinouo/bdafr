-- Script Hash: 9fe69a9628893d3e56782ee8f2b1efeefb9aaf7971013e11fe172e267ece24adcf6ed9994607fc0015ee628c9d17800f
...
function v7.onStart(p2)
	...
	l__LobbyNetEvents__3.server.createCustomMatch:connect(function(p3, p4, p5)
		...
		if v10.disableInCustom then
			print("Selected queue is disabled in custom matches: " .. p4);
			return false;
		end;

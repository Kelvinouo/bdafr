...
v5.teleportToMatch = v1.async(function(p8, p9, p10)
	...
	if not v7 then
		return l__Flamework__4.resolveDependency("@easy-games/game-core:server/services/notification-service@NotificationService"):sendErrorNotification({ p9 }, {
	...
	l__Flamework__4.resolveDependency("@easy-games/game-core:server/services/notification-service@NotificationService"):sendInfoNotification({ p9 }, {
		message = "Teleporting to server..."
	});
	local v8 = u5("TeleportOptions", {

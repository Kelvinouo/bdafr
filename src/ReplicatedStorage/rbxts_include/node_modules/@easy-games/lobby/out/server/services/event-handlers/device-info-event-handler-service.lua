...
local l__LocalizationService__2 = v3.LocalizationService;
local l__AnalyticsService__3 = v3.AnalyticsService;
function v4.connectEvents(p4)
	l__LobbyServerEvents__1.replicateClientData:connect(function(p5, p6)
		...
		p6.locale = u4;
		local v6 = p4.playerDataService:convertCountryToServerRegion(u4);
...
l__Reflect__2.defineMetadata(v4, "flamework:dependencies", { "@easy-games/lobby:server/services/device-info-service@DeviceInfoService" });

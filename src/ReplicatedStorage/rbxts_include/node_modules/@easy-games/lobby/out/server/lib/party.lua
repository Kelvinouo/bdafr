-- Script Hash: 9d75e40eaa432bd74e6928eccadaed9862566e60e68a30379350a8055b6640cd8899254c4fc4ca382b3568f5b08c6459
...
function v2.getDto(p20)
	...
	local function v13(p21)
		return l__OfflinePlayerUtil__4.getOfflinePlayer(p21);
	end;
	local v14 = table.create(#l__members__12);
	for v15, v16 in ipairs(l__members__12) do
		v14[v15] = v13(v16, v15 - 1, l__members__12);
	end;
	v11.members = v14;
	v11.queueData = v7;
...
function v2.setQueueData(p22, p23)
	p22.queueData = p23;
end;
function v2.sendPartyInfoEvent(p24)
	l__LobbyServerEvents__3.partyInfoEvent:fire(p24:getPlayers(), {
		party = p24:getDto()
	});
end;
function v2.getQueueState(p25)
	return p25.queueState;
end;
function v2.setQueueState(p26, p27)
	p26.queueState = p27;
end;
local u6 = v1.import(script, v1.getModule(script, "@rbxts", "inspect").inspect);
function v2.toString(p28)
	return "Party: Leader=" .. p28.leader.Name .. " Members=" .. u6(p28.members) .. " QueueState=" .. tostring(p28.queueState) .. " QueueData=" .. u6(p28.queueData);
end;
local l__Flamework__7 = v1.import(script, v1.getModule(script, "@flamework", "core").out).Flamework;
function v2.getSkillRating(p29, p30)
	local v17 = l__Flamework__7.resolveDependency("@easy-games/lobby:server/services/lobby-server-service@LobbyServerService"):getQueueMeta(p30);
	if not v17.skillResolver then
		return 0;
	end;
	return v17.skillResolver(p29:getPlayers());
end;
function v2.__tostring(p31)
	return p31:toString();
end;

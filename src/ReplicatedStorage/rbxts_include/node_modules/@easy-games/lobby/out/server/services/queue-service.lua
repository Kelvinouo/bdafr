-- Script Hash: e8e00d1661235896fdeb43f7c543e099ad9c5b16fecb37f0c2b5628473134025908daebc9a9cc623eb607405a07b2492
...
v5.onMatchFoundForParty = v1.async(function(p22, p23, p24, p25)
	...
	if table.find(v39, p25.Members[1].Entity.Id) ~= nil then
		...
		v45:SetTeleportData(p22:getMatchTeleportData(v27.queueType, p25, v26.UserId, #p23:getPlayers()));
		...
		if v46 ~= "" and v46 then
			...
			v49:SetTeleportData(p22:getMatchTeleportData(v27.queueType, p25, v26.UserId, #p23:getPlayers()));

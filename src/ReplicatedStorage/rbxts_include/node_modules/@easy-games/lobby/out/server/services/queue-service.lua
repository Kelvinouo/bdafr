-- Script Hash: 82efbb53f212980d85b5aef06971394a001d576b1927933cb95729a2f06352d33db5093b8cd43d126cc4415e322f0aed
...
v5.onMatchFoundForParty = v1.async(function(p22, p23, p24, p25)
	...
	if table.find(v39, p25.Members[1].Entity.Id) ~= nil then
		...
		v45:SetTeleportData(p22:getMatchTeleportData(v27.queueType, p25, v26.UserId));
		...
		local v46 = p22:getServerAccessCode(p24);
		if v46 == nil then
			local v47 = 0;
			local v48 = 2;
			if v47 > 2 then
			...
			while v46 == nil and p23:getLeader().Parent ~= nil and v47 < 10 and { wait(v48) } do
				print("[Queue]: Retrying access code fetch (" .. tostring(v47 + 1) .. ")");
				v46 = p22:getServerAccessCode(p24);
				v47 = v47 + 1;			
			end;
		end;
		if v46 ~= "" and v46 then
			print("[Queue]: Found server access code: " .. v46);
			local v49 = u7("TeleportOptions", {
				ReservedServerAccessCode = v46
			});
			v49:SetTeleportData(p22:getMatchTeleportData(v27.queueType, p25, v26.UserId));
			local u9 = p22.gameTeleportService:getGamePlaceIdForQueueType(v27.queueType);
			task.spawn(function()
				for v50, v51 in ipairs(p23:getPlayers()) do
					p22.playerLocationService:registerPlayer(v51, u9, v46);
				end;
			end);
			v1.await(p22.gameTeleportService:teleportRetry(u9, p23:getPlayers(), v49));
			p22:logMatchFound(p23);
			u8 = true;
		else
...
function v5.getMatchTeleportData(p28, p29, p30, p31)
	return {
		match = {
			matchId = p30.MatchId, 
			queueType = p29, 
...
function v5.getServerAccessCode(p32, p33)
	if not p32.serverAccessCodes then
		return "offline";
	end;
	return p32.serverAccessCodes:GetAsync(p33);
end;
function v5.saveServerAccessCode(p34, p35, p36)

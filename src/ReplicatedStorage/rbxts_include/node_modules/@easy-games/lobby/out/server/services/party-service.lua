...
function v4.disbandParty(p20, p21)
	local v15, v16, v17 = ipairs(p21:getMembers());
	while true do
		v15(v16, v17);
		if not v15 then
			break;
...
function v4.getPartyForPlayer(p22, p23)
	local v18, v19, v20 = ipairs(p22.parties);
	while true do
		v18(v19, v20);
		if not v18 then
			break;
		...
		v20 = v18;
		if table.find(v19:getPlayers(), p23) ~= nil == true then
			return v19;
		end;	
	end;
	return nil;
end;
function v4.getPartyByLeader(p24, p25)
	local v21, v22, v23 = ipairs(p24.parties);
	while true do
		v21(v22, v23);
		if not v21 then
			break;
		...
		v23 = v21;
		if v22:getLeader().UserId == p25 == true then
			return v22;
		end;	
	end;
	return nil;
end;
function v4.getParties(p26)
	return p26.parties;
end;
function v4.getWaitingPlayers(p27)
	return p27.waitingPlayers;
end;
function v4.setWaitingPlayer(p28, p29, p30)
	p28.waitingPlayers[p29] = {
		leaderUserId = p30, 
		time = os.time()
	};
end;

...
function v4.getPartyForPlayer(p22, p23)
	for v17, v18 in ipairs(p22.parties) do
		if table.find(v18:getPlayers(), p23) ~= nil == true then
			return v18;
		end;
	end;
	return nil;
...
function v4.getPartyByLeader(p24, p25)
	for v19, v20 in ipairs(p24.parties) do
		if v20:getLeader().UserId == p25 == true then
			return v20;
		end;
	end;
	return nil;

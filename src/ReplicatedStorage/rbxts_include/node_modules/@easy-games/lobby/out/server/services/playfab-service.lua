...
v5.getPlayerSession = v1.async(function(p13, p14)
	local v20 = p13.playerSessions[p14];
	if v20 then
		local v21 = v20;
	else
		v21 = nil;
	...
	while v22 <= 100 do
		v22 = v22 + 1;
		local v23 = p13.playerSessions[p14];
		if v23 then
			local v24 = v23;
		else
			v24 = nil;
...
function v5.bulkGetPlayerSessions(p15, p16)
	local v25 = {};
	local v26 = 0;
	local v27, v28, v29 = ipairs((u7.values(p15.playerSessions)));
	while true do
		v27(v28, v29);
		if not v27 then
			break;
		end;
		if table.find(p16, v28.Player) ~= nil == true then
			v26 = v26 + 1;
			v25[v26] = v28;
		end;	
	end;

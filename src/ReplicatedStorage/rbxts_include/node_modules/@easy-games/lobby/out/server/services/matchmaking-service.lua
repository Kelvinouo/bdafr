...
v4.pollMatchmakingTickets = v1.async(function(p12)
	...
	local function v27(p13)
		...
		if v30 <= l__Workspace__3:GetServerTimeNow() - v28.lastPollTime then
			v28.pollAttempts = v28.pollAttempts + 1;
			v28.lastPollTime = l__Workspace__3:GetServerTimeNow();
			task.spawn(function()
	...
	return {
		...
		Attributes = {
			DataObject = {
				...
				IsMobile = tostring(v42.device == l__DeviceType__5.Mobile), 
				Skill = p18.skill
			}
		}
	};
...
function v4.registerMatchFoundObserver(p19, p20)
	local l__matchFoundObservers__43 = p19.matchFoundObservers;
	l__matchFoundObservers__43[#l__matchFoundObservers__43 + 1] = p20;
end;

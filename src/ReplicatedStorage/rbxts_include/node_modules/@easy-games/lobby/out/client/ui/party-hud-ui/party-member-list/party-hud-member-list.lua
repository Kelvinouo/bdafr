-- Script Hash: f0bd1d751041b7f1b9ef4988540dacff21a2761978704c3f30cd4f01cfa1fe3a25052b7b54590e2f488251d786d39678
-- Decompiled with the Synapse X Luau decompiler.

local v1 = _G[script];
local v2 = v1.import(script, v1.getModule(script, "@rbxts", "roact").src);
local v3 = v2.Component:extend("PartyHudMemberList");
function v3.init(p1)

end;
local l__Empty__1 = v1.import(script, v1.getModule(script, "@easy-games", "game-core").out).Empty;
local l__PartyHudMember__2 = v1.import(script, script.Parent, "party-hud-member").PartyHudMember;
function v3.render(p2)
	local v4 = { p2.props.PartyMembers.leader };
	local l__members__5 = p2.props.PartyMembers.members;
	...
	local function v6(p3, p4)
		return v2.createElement(l__PartyHudMember__2, {
			Member = p3, 
			LayoutOrder = p4
		});
	end;

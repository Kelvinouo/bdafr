...
function v5.getLocalPartyRole(p3, p4)
	...
	local v9 = nil;
	for v10, v11 in ipairs(l__Party__8.members) do
...
function v5.getLocalPartyPlayers(p5)
	local v12 = { l__LobbyClientConfig__3.store:getState().Party.leader };
	local l__members__13 = l__LobbyClientConfig__3.store:getState().Party.members;
	table.move(l__members__13, 1, #l__members__13, #v12 + 1, v12);
	return v12;
end;
function v5.isInLocalParty(p6, p7)
	local v14 = nil;
	for v15, v16 in ipairs((p6:getLocalPartyPlayers())) do
		if v16.userId == p7.UserId == true then
			v14 = v16;
			break;
		end;
	end;
...
function v5.joinParty(p13, p14)
	local v17 = l__Players__4:GetPlayerByUserId(p14);
	if not v17 then
		return false;
	end;
